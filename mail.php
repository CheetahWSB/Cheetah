 ...
 */
    ...
    require_once( CH_DIRECTORY_PATH_ROOT . 'templates/tmpl_' . $tmpl . '/scripts/ChTemplMailBox.php');
    ...
    $sMessageBody = ( isset($_POST['message']) )
        ...
        //? process_db_input( nl2br( urldecode($_POST['message']) ), CH_TAGS_VALIDATE) : null;
    ...
    (
        // logged member's ID ;
        'member_id'	 => ($iProfileId || $aProfile['Role'] & CH_WSB_ROLE_ADMIN)
            ? $iProfileId
            : 0,
    ...
    // create ChTemplMailBox object
    $oMailBox = new ChTemplMailBox($sComposedPage, $aMailBoxSettings);

    if ( isset($_GET['ajax_mode']) and false !== ch_get('action') ) {
    ...
    $aVars = array ('BaseUri' => CH_WSB_URL_ROOT);
