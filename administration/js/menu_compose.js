...
function initMenu( e )
{
	...
	oMenu = new ChWsbMenu( topParentID, parserUrl, aTopItems, aCustomItems, aSystemItems, aAllItems, aCoords, e )
}
...
function saveItem( id )
{
    ...
    $.post(parserUrl, oRequest, function(oData){
        ...
        $('#formItemEdit').ch_message_box(oData.message, oData.timer, function(){
