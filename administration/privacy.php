...
function _getDefaults($mixedResult, $bActive = false)
{
    ...
    $aGroupIds = $GLOBALS['MySQL']->getColumn("SELECT `id` FROM `sys_privacy_groups` WHERE `owner_id`='0' AND `id` NOT IN('" . implode("','", array(CH_WSB_PG_DEFAULT, CH_WSB_PG_HIDDEN)) . "')");
