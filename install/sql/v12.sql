...
('info', '_adm_tmi_info', 'https://wiki.cheetahwsb.com/index.php', '', 'question-circle', 3),
...
INSERT INTO `sys_objects_cmts` VALUES(1, 'profile', 'sys_cmts_profile', 'sys_cmts_track', 0, 1, 90, 5, 1, -3, 'none', 0, 1, 0, 'cmt', 'Profiles', 'ID', 'CommentsCount', 'ChWsbCmtsProfile', 'inc/classes/ChWsbCmtsProfile.php');
...
('t_Activation', 'Your Profile Is Now Active', '<ch_include_auto:_email_header.html />\r\n\r\n<p><b>Dear <RealName></b>,</p>\r\n\r\n<p>Your profile was reviewed and activated!</p>\r\n\r\n<p>Your Account: <a href="<Domain>member.php"><Domain>member.php</a></p>\r\n\r\n<p>Member ID: <b><recipientID></b></p>\r\n\r\n<p>Your E-mail: <span style="color:#FF6633"><Email></span></p>\r\n\r\n<ch_include_auto:_email_footer.html />', 'Profile activation notification.', 0),
('t_AdminEmail', '<SiteName> Admin: <MessageSubject>', '<ch_include_auto:_email_header.html />\r\n\r\n<p><b>Dear <RealName></b>,</p>\r\n\r\n<p><a href="<Domain>"><SiteName></a> Admin sent you a message:</p>\r\n\r\n<hr>\r\n<p style="color:#3B5C8E"><MessageText></p>\r\n<hr>\r\n\r\n<ch_include_auto:_email_footer.html />', 'Message from the site Admin.', 0),
('t_AdminStats', 'Content Pending Admin Review', '<ch_include_auto:_email_header.html />\r\n\r\n<p><b>Dear <RealName></b>,</p>\r\n\r\n<p><MessageText></p>\r\n\r\n<p>Go to <a href="<ViewLink>">administration panel</a> to review pending content.</p>\r\n\r\n<ch_include_auto:_email_footer.html />', 'Message to admin about content pending review', 0),
('t_Compose', 'You''ve Got A New Message', '<ch_include_auto:_email_header.html />\r\n\r\n<p><b>Hello <RealName></b>,</p>\r\n\r\n<p>You have received a message from <a href="<ProfileUrl>"><ProfileReference></a>!</p>\r\n\r\n<p>Go to your account to read and reply: <a href="<Domain>member.php"><Domain>member.php</a></p>\r\n\r\n<ch_include_auto:_email_footer.html />', 'New message notification without message text', 0),
('t_Confirmation', 'Email Confirmation Request', '<ch_include_auto:_email_header.html />\r\n\r\n<p><b>Dear <RealName></b>,</p>\r\n\r\n<p>Thank you for registering at <SiteName>!</p>\r\n\r\n<p>Click to confirm your email:\r\n<a href="<ConfirmationLink>"><ConfirmationLink></a></p>\r\n\r\n<p>CONFIRMATION CODE: <ConfCode></p>\r\n\r\n<ch_include_auto:_email_footer.html />', 'Email confirmation message.', 0),
('t_CupidMail', 'Your Matches', '<ch_include_auto:_email_header.html />\r\n\r\n<p><b>Hello <RealName></b>,</p>\r\n\r\n<p>Check out some <SiteName> members that may be a good match with you:</p>\r\n\r\n<p><a href="<MatchProfileLink>"><MatchProfileLink></a></p>\r\n\r\n\r\n<ch_include_auto:_email_footer.html />', 'Matching profiles notification.', 0),
('t_Forgot', 'Your Account Password', '<ch_include_auto:_email_header.html />\r\n\r\n<p><b>Dear <RealName></b>,</p>\r\n\r\n<p>Your member ID: <b><recipientID></b></p>\r\n\r\n<p>Your password: <b><Password></b></p>\r\n\r\n<p>You may login here: <a href="<Domain>member.php"><Domain>member.php</a></p>\r\n\r\n\r\n<ch_include_auto:_email_footer.html />', 'Password retrieval', 0),
('t_FreeEmail', 'Member Email Address', '<ch_include_auto:_email_header.html />\r\n\r\n<p><b>Dear <RealName></b>,</p>\r\n\r\n<p><profileNickName>''s contact info:</p> \r\n\r\n<p><profileContactInfo></p>\r\n\r\n\r\n<ch_include_auto:_email_footer.html />', 'Requested Member Email Address', 0),
('t_MemExpiration', 'Your Membership Is About To Expire', '<ch_include_auto:_email_header.html />\r\n\r\n<p><b>Hello <RealName></b>,</p>\r\n\r\n<p>Your <SiteName> <MembershipName> membership will expire in <ExpireDays> days.</p>\r\n\r\n<p>NOTE: -1 means it has already expired</p>\r\n\r\n\r\n<p><a href="<Domain>modules/?r=membership/index/">Renew Membership</a></p>\r\n<ch_include_auto:_email_footer.html />', 'Membership expiration notice', 0),
('t_MemChanged', 'Your Membership Changed', '<ch_include_auto:_email_header.html />\r\n\r\n<p><b>Hello <RealName></b>,</p>\r\n\r\n<p>Your membership level was changed to: <b><a href="<Domain>modules/?r=membership/index/"><MembershipLevel></a></b></p>\r\n\r\n\r\n<ch_include_auto:_email_footer.html />', 'Membership change', 0),
('t_Message', 'You''ve Got A New Message', '<ch_include_auto:_email_header.html />\r\n\r\n<p><b>Dear <RealName></b>,</p>\r\n\r\n<p><a href="<ProfileUrl>"><ProfileReference></a> sent you a message: </p>\r\n\r\n<hr>\r\n<p><MessageText></p>\r\n<hr>\r\n\r\n<p>Go to your account to reply: <a href="<Domain>member.php"><Domain>member.php</a></p>\r\n\r\n<ch_include_auto:_email_footer.html />', 'New message notification with message text', 0),
('t_UserJoined', 'New Member Joined', '<ch_include_auto:_email_header.html />\r\n\r\n<p>New user: <RealName></p> \r\n<p>Email: <Email></p> \r\n\r\n<ch_include_auto:_email_footer.html />', 'Admin notification about new member', 0),
('t_UserConfirmed', 'User Confirmed Email', '<ch_include_auto:_email_header.html />\r\n\r\n<p>User: <RealName></p> \r\n<p>Email: <Email></p> \r\n\r\n<ch_include_auto:_email_footer.html />', 'Admin notification - user confirmed email', 0),
('t_UserMemChanged', 'Member Membership Changed', '<ch_include_auto:_email_header.html />\r\n\r\n<p><RealName>''s membership level was changed to: <b><MembershipLevel></b></p>\r\n\r\n\r\n<ch_include_auto:_email_footer.html />', 'Admin notification about membership change', 0),
('t_UserUnregistered', 'Member Unregistered', '<ch_include_auto:_email_header.html />\r\n\r\n<p>User: <NickName></p> \r\n<p>Email: <Email></p> \r\n<p>was unregistered.</p> \r\n\r\n<ch_include_auto:_email_footer.html />', 'Admin notification about unregistered member', 0),
('t_SpamReport', 'Profile Spam Report', '<ch_include_auto:_email_header.html />\r\n\r\n<p><a href="<Domain>profile.php?ID=<reporterID>"><reporterNick></a> reported Profile SPAM:  <a href="<Domain>profile.php?ID=<spamerID>"><b><spamerNick></b></a></p>\r\n\r\n<ch_include_auto:_email_footer.html />', 'Profile Spam Report', 0),
('t_TellFriend', 'Check This Out!', '<ch_include_auto:_email_header.html />\r\n\r\n\r\n<p>I thought you''d be interested: <a href="<Link>"><Link></a><br />\r\n---<br />\r\n<a href="<SenderLink>"><SenderName></a>\r\n</p>\r\n\r\n<ch_include_auto:_email_footer.html />', 'Friend Invitation', 0),
('t_TellFriendProfile', 'Look At This Profile', '<ch_include_auto:_email_header.html />\r\n\r\n\r\n\r\n<p>Check out this profile: <a href="<Link>"><Link></a><br />\r\n---<br />\r\n<a href="<SenderLink>"><SenderName></a>\r\n</p>\r\n\r\n<ch_include_auto:_email_footer.html />', 'Email profile to a friend', 0),
('t_VKiss', 'Greeting notification', '<ch_include_auto:_email_header.html />\r\n\r\n<p><b>Dear <RealName></b>,</p>\r\n\r\n<p><ProfileReference> sent you a greeting!</p>\r\n\r\n<p><ProfileReference> may be interested in you or maybe just wants to say Hello!\r\n</p>\r\n\r\n<ch_include_auto:_email_footer.html />', 'Greeting notification ', 0),
('t_VKiss_visitor', 'Greeting notification', '<ch_include_auto:_email_header.html />\r\n\r\n<p><b>Dear <RealName></b>,</p>\r\n\r\n<p>Our site visitor sent you a greeting!</p>\r\n\r\n\r\n<ch_include_auto:_email_footer.html />', 'Greeting from visitor notification', 0),
('t_MessageCopy', 'Copy Of Your Message : <your subject here>', '<ch_include_auto:_email_header.html />\r\n\r\n<p>You wrote:</p>\r\n<hr>\r\n<p><your message here></p>\r\n<hr>\r\n\r\n<ch_include_auto:_email_footer.html />', 'Message copy', 0),
('t_Subscription', 'Your Subscription', '<ch_include_auto:_email_header.html />\r\n\r\n<p><b>Dear <RealName></b>,</p>\r\n\r\n<p>You subscribed to <a href="<ViewLink>"><Subscription></a></p>\r\n\r\n<p>You may cancel the subscription here: <a href="<SysUnsubscribeLink>"><SysUnsubscribeLink></a></p>\r\n\r\n<ch_include_auto:_email_footer.html />', 'Subscription confirmation', 0),
('t_sbsProfileComments', 'New Profile Comments', '<ch_include_auto:_email_header.html />\r\n\r\n <p><b>Dear <RealName></b>,</p>\r\n\r\n<p>Profile you subscribed to got <a href="<ViewLink>">new comments</a>.</p>\r\n\r\n<ch_include_auto:_email_footer.html />', 'New comments to profile subscription', 0),
('t_sbsProfileEdit', 'Subscription: Profile Edited', '<ch_include_auto:_email_header.html />\r\n\r\n<p><b>Dear <RealName></b>,</p>\r\n\r\n<p><a href="<ViewLink>">Profile you subscribed to</a> has been updated.</p>\r\n\r\n<ch_include_auto:_email_footer.html />', 'Profile info subscription.', 0),
('t_FriendRequest', 'Friendship Request', '<ch_include_auto:_email_header.html />\r\n\r\n    <p><b>Dear <Recipient></b>,</p>\r\n   \r\n    <p><a href="<SenderLink>"><Sender></a> wants to be friends with you. <a href="<RequestLink>">Respond</a>.</p>\r\n    <br /> \r\n    <ch_include_auto:_email_footer.html />', 'Friendship Request', 0),
...
('{evalResult}', 'MemberBlock', '', '{ProfileLink}', '', 'return ''<b class="menu_item_username">'' . getNickName({ID}) . ''</b>'';', 'ch_import(''ChWsbUserStatusView'');\r\n$oStatusView = new ChWsbUserStatusView();\r\nreturn $oStatusView->getMemberMenuStatuses();', 1, 1, 3, 1, 0, 0, '', 'top', 'link', 0, '', '_Presence'),

('_Mail', 'Mail', 'envelope', 'mail.php?mode=inbox', '', '', 'ch_import( ''ChTemplMailBox'' );\r\n// return list of messages ;\r\nreturn ChTemplMailBox::get_member_menu_messages_list({ID});', 1, 1, 3, 1, 0, 0, '', 'top_extra', 'link', 0, 'ch_import( ''ChTemplMailBox'' );\r\n// return list of new messages ;\r\n$aRetEval= ChTemplMailBox::get_member_menu_bubble_new_messages({ID}, {iOldCount});', '_Mail'),
('_Friends', 'Friends', 'users', 'viewFriends.php?iUser={ID}', '', '', 'ch_import( ''ChWsbFriendsPageView'' );\r\nreturn ChWsbFriendsPageView::get_member_menu_friends_list({ID});', 3, 1, 3, 1, 0, 0, '', 'top_extra', 'link', 0, 'ch_import( ''ChWsbFriendsPageView'' );\r\n$aRetEval = ChWsbFriendsPageView::get_member_menu_bubble_friend_requests( {ID}, {iOldCount});', '_Friends'),
('_sys_pmt_shopping_cart_caption', 'ShoppingCart', 'shopping-cart', 'cart.php', '', '', 'ch_import(''ChWsbPayments'');\r\nreturn ChWsbPayments::getInstance()->getCartItems();', 4, 1, 3, 1, 0, 0, '', 'top_extra', 'link', 0, 'ch_import(''ChWsbPayments'');\r\n$oPayment = ChWsbPayments::getInstance();\r\nif($oPayment->isActive()) $aRetEval = $oPayment->getCartItemCount({ID}, {iOldCount}); else $isSkipItem = true;', '_sys_pmt_shopping_cart_description'),
...
('sys_member_info_name', 'sys_username', @iCatProfiles, 'Member display-name', 'select', '', '', 130, 'PHP:ch_import(\'ChWsbMemberInfoQuery\'); return ChWsbMemberInfoQuery::getMemberInfoKeysByType(\'name\');'),
('sys_member_info_info', 'sys_status_message', @iCatProfiles, 'Member brief info', 'select', '', '', 140, 'PHP:ch_import(\'ChWsbMemberInfoQuery\'); return ChWsbMemberInfoQuery::getMemberInfoKeysByType(\'info\');'),
('sys_member_info_thumb', 'sys_avatar', @iCatProfiles, 'Member thumb', 'select', '', '', 150, 'PHP:ch_import(\'ChWsbMemberInfoQuery\'); return ChWsbMemberInfoQuery::getMemberInfoKeysByType(\'thumb\');'),
('sys_member_info_thumb_icon', 'sys_avatar_icon', @iCatProfiles, 'Member thumb icon', 'select', '', '', 160, 'PHP:ch_import(\'ChWsbMemberInfoQuery\'); return ChWsbMemberInfoQuery::getMemberInfoKeysByType(\'thumb_icon\');');
...
('sys_ftp_dir', '', @iCatGeneral, 'Path to Cheetah on FTP server', 'digit', '', '', 4, ''),
...
('news_enable', 'on', @iCatGeneral, 'Enable Cheetah News in Admin', 'checkbox', '', '', 90, ''),
('feeds_enable', 'on', @iCatGeneral, 'Enable Cheetah Market Feeds in Admin', 'checkbox', '', '', 100, ''),
...
('cheetahAffID', '', @iCatGeneral, 'Cheetah affiliate ID', 'digit', '', '', 140, ''),
...
('ext_breadcrumb_menu_enabled', 'on', @iCatTemplate, 'Enable breadcrumb menu', 'checkbox', '', '', 80, ''),
('ext_nav_menu_top_position', 'bottom', @iCatTemplate, 'Default position of member menu', 'select', '', '', 90, 'top,bottom,static');

-- CAT: Security
SET @iCatSecurity = 14;
INSERT INTO `sys_options` VALUES
('sys_security_form_token_enable', '', @iCatSecurity, 'Enable CSRF token in forms', 'checkbox', '', '', 30, ''),
...
('sys_db_cache_engine', 'File', @iCatCaching, 'DB cache engine (other than File option may require custom server setup)', 'select', '', '', 30, 'File,Memcache'),
...
('sys_pb_cache_enable', '', @iCatCaching, 'Enable page blocks cache', 'checkbox', '', '', 60, ''),
('sys_pb_cache_engine', 'File', @iCatCaching, 'Page blocks cache engine (other than File option may require custom server setup)', 'select', '', '', 70, 'File,Memcache'),
('sys_mm_cache_engine', 'File', @iCatCaching, 'Member menu cache engine (other than File option may require custom server setup)', 'select', '', '', 80, 'File,Memcache'),
('sys_template_cache_enable', '', @iCatCaching, 'Enable cache for HTML files', 'checkbox', '', '', 90, ''),
('sys_template_cache_engine', 'FileHtml', @iCatCaching, 'Template cache engine (other than FileHtml option may require custom server setup)', 'select', '', '', 100, 'FileHtml,Memcache'),
('sys_template_cache_css_enable', '', @iCatCaching, 'Enable cache for CSS files', 'checkbox', '', '', 110, ''),
('sys_template_cache_js_enable', '', @iCatCaching, 'Enable cache for JS files', 'checkbox', '', '', 120, ''),
('sys_template_cache_compress_enable', '', @iCatCaching, 'Enable compression for JS/CSS files(cache must be enabled)', 'checkbox', '', '', 130, '');
...
('', '1140px', 'Raw HTML Block', '_RAW_Html_Block', 0, 0, 'Sample', 'Text', 11, 0, 'non,memb', 0, 0),
('', '1140px', 'Simple Text Block', '_Text Block', 0, 0, 'Sample', 'TrueText', 11, 0, 'non,memb', 0, 0),

('index', '1140px', 'Shows statistic information about your site content', '_Site Stats', 2, 2, 'SiteStats', '', 1, 28.1, 'non,memb', 0, 300),
...
('index', '1140px', 'Shows Login Form', '_Member_Login', 0, 0, 'LoginSection', '', 11, 28.1, 'non', 0, 3600),
('index', '1140px', '', '_Cheetah News', 1, 0, 'RSS', 'https://www.cheetahwsb.com/m/news/act_rss/4', 1, 71.9, 'non,memb', 0, 300),
...
('search_home', '1140px', 'Keyword Search', '_sys_box_title_search_keyword', 1, 0, 'Keyword', '', 1, 71.9, 'non,memb', 0, 3600),
...
('join', '1140px', 'Login Form Block', '_Login', 0, 0, 'LoginSection', 'no_join_text', 11, 100, 'non', 250, 3600),
...
('tags_search', '1140px', 'Search Form', '_tags_search_form', 1, 0, 'Form', '', 1, 100, 'non,memb', 0, 3600),
...
('categ_search', '1140px', 'Search Form', '_categ_caption_search_form', 1, 0, 'Form', '', 1, 100, 'non,memb', 0, 3600),
...
--
-- Dumping data for table `sys_sa_tokens`
--
...
INSERT INTO `sys_objects_search` VALUES(3, 'profile', '_Profiles', 'ChTemplSearchProfile', 'templates/tmpl_{tmpl}/scripts/ChTemplSearchProfile.php');
...
(107, 118, 'Privacy Groups', '_ps_tmenu_privacy_settings', 'member_privacy.php', 5, 'memb', '', '', 'ch_import(\'ChWsbPrivacy\'); return ChWsbPrivacy::isPrivacyPage();', 3, 1, 1, 0, 1, 'custom', '', '', 0, ''),
...
INSERT INTO `sys_objects_vote` VALUES(1, 'profile', 'sys_profile_rating', 'sys_profile_voting_track', 'pr_', '5', 'vote_send_result', 'CH_PERIOD_PER_VOTE', '1', '', '', 'Profiles', 'Rate', 'RateCount', 'ID', '', '');
...
('browser_check', 0, 'injection_footer', 'php', 'if(getParam(\'enable_browser_check\') && $_GET[\'enable_browser_check\'] != \'false\') { $sCode = \'<script>var $buoop={required:{e:-4,f:-3,o:-3,s:-1,c:-3},insecure:!0,api:2020.09};function $buo_f(){var e=document.createElement("script");e.src="//browser-update.org/update.min.js",document.body.appendChild(e)}try{document.addEventListener("DOMContentLoaded",$buo_f,!1)}catch(e){window.attachEvent("onload",$buo_f)}</script>\'; echo $sCode; }', 0, 1);
...
--
INSERT INTO `sys_alerts_handlers`(`name`, `class`, `file`) VALUES('ch_videos_comments_delete', 'ChWsbVideoDeleteResponse', 'flash/modules/video_comments/inc/classes/ChWsbVideoDeleteResponse.php');
...
('system', '', '', 'return array(''template'' => array(''Subscription'' => _t(''_sbs_txt_sbs_mass_mailer''), ''ViewLink'' => CH_WSB_URL_ROOT));'),
('system', 'mass_mailer', 't_AdminEmail', 'return array(''template'' => array(''Subscription'' => _t(''_sbs_txt_sbs_mass_mailer''), ''ViewLink'' => CH_WSB_URL_ROOT));'),
...
('cmd', '0 0 * * *', 'ChWsbCronCmd', 'inc/classes/ChWsbCronCmd.php', ''),
('notifies', '*/10 * * * *', 'ChWsbCronNotifies', 'inc/classes/ChWsbCronNotifies.php', ''),
...
('system', '_sys_sitemap_system', '0.6', 'weekly', 'ChWsbSiteMapsSystem', '', 1, 1),
('profiles', '_sys_sitemap_profiles', '0.8', 'daily', 'ChWsbSiteMapsProfiles', '', 2, 1),
('profiles_info', '_sys_sitemap_profiles_info', '0.8', 'daily', 'ChWsbSiteMapsProfilesInfo', '', 3, 1),
('pages', '_sys_sitemap_pages', '0.8', 'weekly', 'ChWsbSiteMapsPages', '', 4, 1);
...
('sys_recaptcha', 'reCAPTCHA', 'ChTemplCaptchaReCAPTCHA', '');
