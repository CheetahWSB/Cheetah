...
<ol class="adm-ds-help ch-def-font-large">
  ...
  '_adm_txt_hosting_text' => '90% of configuration and installation issues result from incorrect hosting setup. Cheetah constantly works with a number of quality hosts and we recommend the best ones. Moreover, Cheetah customers generally receive better deals and accounts tailored specifically for Cheetah.',
  ...
  '_adm_txt_templ_uni_desc' => 'The default template for Cheetah, universally suitable for variety of social networking website niches. UNI is optimized for large screen resolutions and features minimalistic layout with vector-based icons (good for "retina" screens).',
