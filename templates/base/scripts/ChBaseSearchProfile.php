...
require_once(CH_DIRECTORY_PATH_BASE . 'scripts/ChBaseSearchResultText.php');

class ChBaseSearchProfile extends ChBaseSearchResultText
{
    var $aCurrent = array(
        'name' => 'profile',
        'title' => '_People',
    ...
    */
    function PrintSearhResult($aProfileInfo, $aCoupleInfo = '', $aExtendedKey = null, $sTemplateName = '', $oCustomTemplate = null)
    {
        ...
        $bPublic = $bExtMode ? ch_check_profile_visibility ($aProfileInfo['ID'], $iVisitorID, true) : true;
