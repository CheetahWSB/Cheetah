 ...
 */
    ...
    require_once( CH_DIRECTORY_PATH_CLASSES . 'ChWsbCommunicator.php');

    class ChBaseCommunicator extends ChWsbCommunicator
    {
        ...
        */
        ...
        function getBlockCode_Connections()
        {
            ...
            $sRequest = CH_WSB_URL_ROOT . 'communicator.php?';
        ...
        function getProcessingRows($bShowEmpty = true)
        {
            ...
            $sRequest = CH_WSB_URL_ROOT . 'communicator.php?action=get_page' ;
            ...
            $aTemplateKeys = array (
                ...
                'error_message'            => ch_js_string(_t( '_Please, select at least one message' )),
                'sure_message'             => ch_js_string(_t( '_Are_you_sure' )),
