...
function isCheetahWidgetsRegistered()
{
    global $sGlobalDir;
    return getSettingValue($sGlobalDir, "registered") == TRUE_VAL;
}

function setRayCheetahLicense($sLicense)
{
...
?>
            <input type="hidden" name="<?=process_db_input($sKey, CH_TAGS_SPECIAL_CHARS)?>" value="<?=process_db_input($sValue, CH_TAGS_SPECIAL_CHARS)?>" />
<?php
        }
?>
    </form>
