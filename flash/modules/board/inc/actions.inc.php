...
$sTitle = isset($_REQUEST['title']) ? process_db_input(rawurldecode($_REQUEST['title']), CH_TAGS_SPECIAL_CHARS) : "";
...
switch ($sAction) {
    ...
    */
    ...
    case 'transmit':
        ...
        $sData = isset($_REQUEST['data']) ? process_db_input($_REQUEST['data'], CH_TAGS_STRIP) : "";
        $iQuality = 100;
