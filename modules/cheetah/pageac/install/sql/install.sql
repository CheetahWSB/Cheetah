...
(2, 'ch_pageac', '_ch_pageac', '{siteUrl}modules/?r=pageac/admin/', 'Page Access Control', 'unlock', '', '', @iOrder+1);
...
('ch_pageac', 'ChWsbService::call(''pageac'', ''responce_protect_URL'', array($_SERVER[''REQUEST_URI'']));');
