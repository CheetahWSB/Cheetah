...
ChWallView.prototype.initEvents = function(oEvents) {
	var $this = this;
...
ChWallView.prototype.hideEvents = function(oEvents, fOffset) {
...
ChWallView.prototype.showEvents = function(oEvents, fOffset) {
	oEvents.each(function() {
...
ChWallView.prototype.deletePost = function(iId) {
	var $this = this;
...
ChWallView.prototype.changeFilter = function(oLink) {
...
ChWallView.prototype.changeTimeline = function(oEvent) {
	this._oRequestParams.WallStart = 0;
    this._oRequestParams.WallPerPage = null;
...
ChWallView.prototype.changePage = function(iStart, iPerPage) {
...
ChWallView.prototype.getPosts = function(sAction) {
    var $this = this;
        ...
        function(sResult) {
            if(sAction == 'page') {
	            ...
	            $('#bxwall .wall-view .wall-load-more').bxwallanim('hide', $this._sAnimationEffect, $this._iAnimationSpeed, function() {
	                ...
	                oEvents.find('a.ch-link').dolEmbedly();
...
ChWallView.prototype.getTimeline = function() {
    var $this = this;
    ...
    jQuery.post (
        ...
        function(sResult) {
            ...
            $('#bxwall .wall-view .wall-timeline').chwsbcmtanim('hide', $this._sAnimationEffect, $this._iAnimationSpeed, function() {
            	$(this).html(sResult);
...
ChWallView.prototype.getPaginate = function() {
    var $this = this;
    ...
    jQuery.post (
        ...
        function(sResult) {
            ...
            $('#bxwall > .paginate').chwsbcmtanim('hide', $this._sAnimationEffect, $this._iAnimationSpeed, function() {
                if(sResult.length > 0) {
...
ChWallView.prototype.showMoreContent = function(oLink) {
	$(oLink).parent('span').next('span').show().prev('span').remove();
	this.reloadMasonry();
};

ChWallView.prototype._getDefaultData = function () {
	var oDate = new Date();
	this._oRequestParams._t = oDate.getTime();
    return this._oRequestParams;
};

ChWallView.prototype._err = function (oElement, bShow, sMessage) {
