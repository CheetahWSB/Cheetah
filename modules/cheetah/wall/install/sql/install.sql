...
('index', '1140px', 'Events Outline', '_wall_pc_view_index_ol', 1, IFNULL(@iPCOrderIndex, 0), 'PHP', 'return ChWsbService::call(\'wall\', \'view_block_index_outline\');', 1, 71.9, 'non,memb', 0),
('index', '1140px', 'Home Timeline: Post', '_wall_pc_post_index_tl', 1, IFNULL(@iPCOrderIndex, 0)+1, 'PHP', 'return ChWsbService::call(\'wall\', \'post_block_index_timeline\');', 1, 71.9, 'memb', 0),
('index', '1140px', 'Home Timeline: View', '_wall_pc_view_index_tl', 1, IFNULL(@iPCOrderIndex, 0)+2, 'PHP', 'return ChWsbService::call(\'wall\', \'view_block_index_timeline\');', 1, 71.9, 'non,memb', 0),
('profile', '1140px', 'Profile Timeline: Post', '_wall_pc_post_profile_tl', 3, IFNULL(@iPCOrderProfile, 0), 'PHP', 'return ChWsbService::call(\'wall\', \'post_block_profile_timeline\', array($this->oProfileGen->_iProfileID));', 1, 71.9, 'memb', 0),
('profile', '1140px', 'Profile Timeline: View', '_wall_pc_view_profile_tl', 3, IFNULL(@iPCOrderProfile, 0)+1, 'PHP', 'return ChWsbService::call(\'wall\', \'view_block_profile_timeline\', array($this->oProfileGen->_iProfileID));', 1, 71.9, 'non,memb', 0),
('member', '1140px', 'Friends Timeline: View', '_wall_pc_view_account_tl', 1, IFNULL(@iPCOrderMember, 0), 'PHP', 'return ChWsbService::call(\'wall\', \'view_block_account_timeline\', array($this->iMember));', 1, 71.9, 'memb', 0),
...
(2, 'ch_wall', '_wall_admin_menu_sitem', '{siteUrl}modules/?r=wall/admin/', 'For managing Timeline', 'clock-o', '', '', @iOrder+1);
...
VALUES('ch_wall', '[db_prefix]comments', '[db_prefix]comments_track', 0, 1, 90, 9999, 1, -3, 'none', 0, 1, 0, 'wcmt', '', '', '', 'ChWallCmts', 'modules/cheetah/wall/classes/ChWallCmts.php');
...
VALUES ('ch_wall', '[db_prefix]voting', '[db_prefix]voting_track', 'wall_', 5, 'vote_send_result', 'CH_PERIOD_PER_VOTE', 1, '', '', '', '', '', '', 'ChWallVoting', 'modules/cheetah/wall/classes/ChWallVoting.php');
...
('wall_events_hide_timeline', '', @iCategoryId, 'Hide events from Timeline', 'select_multiple', '', '', 9, 'PHP:return ChWsbService::call(\'wall\', \'get_actions_checklist\', array(\'timeline\'));'),
('wall_events_hide_outline', '', @iCategoryId, 'Hide events from Outline', 'select_multiple', '', '', 10, 'PHP:return ChWsbService::call(\'wall\', \'get_actions_checklist\', array(\'outline\'));'),
('wall_uploaders_hide_timeline', '', @iCategoryId, 'Hide uploaders from Post to Timeline block', 'select_multiple', '', '', 11, 'PHP:return ChWsbService::call(\'wall\', \'get_uploaders_checklist\', array(\'timeline\'));');
...
('wall', 0, 'ch_photos', 0, 'active'),
('wall', 0, 'ch_sounds', 0, 'active'),
('wall', 0, 'ch_videos', 0, 'active');


INSERT INTO `sys_permalinks`(`standard`, `permalink`, `check`) VALUES('modules/?r=wall/', 'm/wall/', 'permalinks_module_wall');


INSERT INTO `sys_alerts_handlers`(`name`, `class`, `file`, `eval`) VALUES ('ch_wall', '', '', 'ChWsbService::call(\'wall\', \'response\', array($this));');
...
('ch_wall', '', '', 'return ChWsbService::call(\'wall\', \'get_subscription_params\', array($arg1, $arg2, $arg3));'),
('ch_wall', 'update', 't_sbsWallUpdates', 'return ChWsbService::call(\'wall\', \'get_subscription_params\', array($arg1, $arg2, $arg3));');

INSERT INTO `sys_email_templates`(`Name`, `Subject`, `Body`, `Desc`, `LangID`) VALUES
('t_sbsWallUpdates', 'Subscription: New Timeline Event', '<ch_include_auto:_email_header.html />\r\n\r\n<p><b>Dear <RealName></b>,</p>\r\n\r\n<p>\r\nThere was a new update of the Timeline you subscribed to!\r\n</p>\r\n\r\n<p>\r\n<a href="<ViewLink>">View it now</a>\r\n</p>\r\n\r\n<ch_include_auto:_email_footer.html />', 'Subscription: New Timeline Event', 0);

-- chart
SET @iMaxOrderCharts = (SELECT MAX(`order`)+1 FROM `sys_objects_charts`);
INSERT INTO `sys_objects_charts` (`object`, `title`, `table`, `field_date_ts`, `field_date_dt`, `query`, `active`, `order`) VALUES
('ch_wall', '_ch_wall_chart', 'ch_wall_events', 'date', '', '', 1, @iMaxOrderCharts);

-- export
SET @iMaxOrderExports = (SELECT MAX(`order`)+1 FROM `sys_objects_exports`);
INSERT INTO `sys_objects_exports` (`object`, `title`, `class_name`, `class_file`, `order`, `active`) VALUES
('ch_wall', '_wall', 'ChWallExport', 'modules/cheetah/wall/classes/ChWallExport.php', @iMaxOrderExports, 1);
