...
class ChSpyExport extends ChWsbExport
{
    protected function __construct($aSystem)
    {
        parent::__construct($aSystem);
        $this->_aTables = array(
            'ch_spy_data' => '`sender_id` = {profile_id} OR `recipient_id` = {profile_id}',
            'ch_spy_friends_data' => '`sender_id` = {profile_id} OR `friend_id` = {profile_id}',
        );
    }
}
