 ...
 */
    ...
    class ChSpyResponseProfiles extends ChWsbAlertsResponse
    {
        var $_oModule;
        ...
        function response($oAlert)
        {
            ...
            switch($oAlert->sUnit . '_' .$oAlert->sAction ) {
                case 'profile_join' :
                    $aParams = array(
                        'lang_key'  => '_ch_spy_profile_has_joined',
                        'params'    => array(
                ...
                case 'profile_edit' :
                    $aParams = array(
                        'lang_key'  => '_ch_spy_profile_has_edited',
                        'params'    => array(
                            'profile_link' => $sRecipientLink,
                            'profile_nick' => $sRecipientName,
                        ),
                ...
                case 'profile_edit_status_message' :
                    $aParams = array(
                        'lang_key'  => '_ch_spy_profile_has_edited_status_message',
                        'params'    => array(
                            'profile_link' => $sRecipientLink,
                            'profile_nick' => $sRecipientName,
                        ),
                ...
                case 'profile_rate' :
                    ...
                    $aParams = array(
                        'lang_key'  => '_ch_spy_profile_has_rated',
                        'params'    => array(
                ...
                case 'profile_commentPost' :
                    ...
                    $aParams = array(
                        'lang_key'  => '_ch_spy_profile_has_commented',
                        'params'    => array(
                            'sender_p_link' => $sSenderProfileLink,
                            'sender_p_nick' => $sSenderNickName,
                            'recipient_p_link' => $sRecipientLink,
                ...
                case 'friend_accept':
                    ...
                    $aParams = array(
                        'lang_key'  => '_ch_spy_profile_friend_accept',
                        'params'    => array(
