    ...
    --
    -- Table structure for table `ch_shoutbox_messages`
    --
    ...
    --
    -- Table structure for table `ch_shoutbox_objects`
    --
    ...
    ('ch_shoutbox', '_ch_shoutbox', '[db_prefix]messages', '', '', '');
    ...
    (`Page`, `PageWidth`, `Desc`, `Caption`, `Column`, `Order`, `Func`, `Content`, `DesignBox`, `ColWidth`, `Visible`, `MinWidth`)
        VALUES
    ('index', '960px', 'Shoutbox', '_ch_shoutbox', 2, 5, 'PHP', 'ChWsbService::call(''shoutbox'', ''get_shoutbox'');', 11, 50, 'non,memb', 0);
   ...
   INSERT INTO
    ...
    (`name`, `time`, `class`, `file`)
        VALUES
    ('ChShoutBox', '*/5 * * * *', 'ChShoutBoxCron', 'modules/cheetah/shoutbox/classes/ChShoutBoxCron.php');
    ...
    ('ch_shoutbox', '_ch_shoutbox_chart', 'ch_shoutbox_messages', '', 'Date', '', 1, @iMaxOrderCharts);

    INSERT INTO `sys_alerts_handlers` (`name`, `eval`) VALUES ('ch_shoutbox_profile_delete', 'ChWsbService::call(''shoutbox'', ''response_profile_delete'', array($this));');
    ...
    ('ch_shoutbox', '_sys_module_shoutbox', 'ChShoutBoxExport', 'modules/cheetah/shoutbox/classes/ChShoutBoxExport.php', @iMaxOrderExports, 1);
