...
require_once('ChPhotosCmtsAlbums.php');

class ChPhotosPageAlbumView extends ChWsbPageView
{
    var $aInfo;
    var $iProfileId;
    ...
    {
        parent::__construct('ch_photos_album_view');
        $this->aInfo = $aInfo;
    ...
    function getBlockCode_Comments()
    {
        ...
        $oCmtsView = new ChPhotosCmtsAlbums($this->oConfig->getMainPrefix() . '_albums', $this->aInfo['ID']);
