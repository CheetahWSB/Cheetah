...
/**
 * Sitemaps generator for Photo Albums
 */
class ChPhotosSiteMapsAlbums extends ChWsbSiteMaps
{
    protected $_oModule;
    ...
    protected function __construct($aSystem)
    {
        ...
        $this->_aQueryParts = array (
            ...
            'join' => "", // join SQL part
            'where' => "AND `Type` = 'ch_photos' AND `Status` = 'active' AND `ObjCount` > 0 AND `AllowAlbumView` = '" . CH_WSB_PG_ALL . "'", // SQL condition, without WHERE
