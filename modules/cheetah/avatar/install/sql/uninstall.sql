...
-- compose pages
DELETE FROM `sys_page_compose_pages` WHERE `Name` IN('ch_avatar_main');
DELETE FROM `sys_page_compose` WHERE `Page` IN('ch_avatar_main');
...
-- admin menu
DELETE FROM `sys_menu_admin` WHERE `name` = 'ch_avatar';

-- actions menu
DELETE FROM `sys_objects_actions` WHERE `Type` = 'ch_photos' AND `Caption` = '{TitleAvatar}';

-- settings
SET @iCategId = (SELECT `ID` FROM `sys_options_cats` WHERE `name` = 'Avatar' LIMIT 1);
DELETE FROM `sys_options` WHERE `kateg` = @iCategId;
DELETE FROM `sys_options_cats` WHERE `ID` = @iCategId;
DELETE FROM `sys_options` WHERE `Name` = 'ch_avatar_permalinks';
...
-- alerts
SET @iHandler := (SELECT `id` FROM `sys_alerts_handlers` WHERE `name` = 'ch_avatar' LIMIT 1);
DELETE FROM `sys_alerts` WHERE `handler_id` = @iHandler;
DELETE FROM `sys_alerts_handlers` WHERE `id` = @iHandler;

-- export
DELETE FROM `sys_objects_exports` WHERE `object` = 'ch_avatar';
