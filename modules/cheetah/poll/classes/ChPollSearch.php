...
require_once( 'ChPollModule.php' );

class ChPollSearch extends ChTemplSearchResultText
{
    var $oPollObject;
    var $aModule;
    ...
    function __construct($oPollObject = null)
    {
        ...
        if(!$oPollObject) {
            $this -> oPollObject = ChWsbModule::getInstance('ChPollModule');
        } else {
    ...
    function showPagination($aParams = array())
    {
        ...
        $oPaginate = new ChWsbPaginate( array_shift($aParameters) );
