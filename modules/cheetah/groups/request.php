...
class ChGroupsRequest extends ChWsbRequest
{
    ...
    public static function processAsAction($aModule, &$aRequest, $sClass = "Module")
    {
        ...
        $GLOBALS['oTopMenu']->setCustomSubActions($aVars, 'ch_groups_title', false);

        return ChWsbRequest::processAsAction($aModule, $aRequest, $sClass);
    }
}

ChGroupsRequest::processAsAction($GLOBALS['aModule'], $GLOBALS['aRequest']);
