...
class ChGroupsFormAdd extends ChWsbFormMedia
{
    var $_oMain, $_oDb;
    ...
    function __construct ($oMain, $iProfileId, $iEntryId = 0, $iThumb = 0)
    {
        ...
        if (ChWsbRequest::serviceExists('photos', 'perform_photo_upload', 'Uploader'))
            $this->_aMedia['images'] = array (
                ...
                'tag' => CH_GROUPS_PHOTOS_TAG,
                'cat' => CH_GROUPS_PHOTOS_CAT,
                'thumb' => 'thumb',
                'module' => 'photos',
                'title_upload_post' => 'images_titles',
                'title_upload' => _t('_ch_groups_form_caption_file_title'),
        ...
        if (ChWsbRequest::serviceExists('videos', 'perform_video_upload', 'Uploader'))
            $this->_aMedia['videos'] = array (
                ...
                'tag' => CH_GROUPS_VIDEOS_TAG,
                'cat' => CH_GROUPS_VIDEOS_CAT,
                'thumb' => false,
                'module' => 'videos',
        ...
        if (ChWsbRequest::serviceExists('sounds', 'perform_music_upload', 'Uploader'))
            $this->_aMedia['sounds'] = array (
                ...
                'tag' => CH_GROUPS_SOUNDS_TAG,
                'cat' => CH_GROUPS_SOUNDS_CAT,
                'thumb' => false,
                'module' => 'sounds',
        ...
        if (ChWsbRequest::serviceExists('files', 'perform_file_upload', 'Uploader'))
            $this->_aMedia['files'] = array (
                ...
                'tag' => CH_GROUPS_FILES_TAG,
                'cat' => CH_GROUPS_FILES_CAT,
                'thumb' => false,
                'module' => 'files',
        ...
        $aInputPrivacyCustom[] = array ('key' => 'f', 'value' => _t('_ch_groups_privacy_fans_only'));
        ...
        $aInputPrivacyCustom2 = array (
            array('key' => 'f', 'value' => _t('_ch_groups_privacy_fans')),
            array('key' => 'a', 'value' => _t('_ch_groups_privacy_admins_only'))
        );
        ...
        $aCustomForm = array(
            ...
            'inputs' => array(
                ...
                'header_info' => array(
                    'type' => 'block_header',
                    'caption' => _t('_ch_groups_form_header_info')
                ),

                'title' => array(
                    'type' => 'text',
                    'name' => 'title',
                    'caption' => _t('_ch_groups_form_caption_title'),
                    'required' => true,
                    'checker' => array (
                        'func' => 'length',
                        'params' => array(3,100),
                        'error' => _t ('_ch_groups_form_err_title'),
                    ),
                    'db' => array (
                        'pass' => 'Xss',
                    ),
                ...
                'desc' => array(
                    'type' => 'textarea',
                    'name' => 'desc',
                    'caption' => _t('_ch_groups_form_caption_desc'),
                    'required' => true,
                    'html' => 2,
                    'checker' => array (
                        'func' => 'length',
                        'params' => array(20,64000),
                        'error' => _t ('_ch_groups_form_err_desc'),
                    ),
                    'db' => array (
                        'pass' => 'XssHtml',
                    ),
                ...
                'country' => array(
                    'type' => 'select',
                    'name' => 'country',
                    'caption' => _t('_ch_groups_form_caption_country'),
                    'values' => $aCountries,
                    'required' => false,
                    'db' => array (
                        'pass' => 'Preg',
                ...
                'city' => array(
                    'type' => 'text',
                    'name' => 'city',
                    'caption' => _t('_ch_groups_form_caption_city'),
                    'required' => false,
                    'db' => array (
                        'pass' => 'Xss',
                    ),
                ...
                'zip' => array(
                    'type' => 'text',
                    'name' => 'zip',
                    'caption' => _t('_ch_groups_form_caption_zip'),
                    'required' => false,
                    'db' => array (
                        'pass' => 'Xss',
                    ),
                ...
                'tags' => array(
                    ...
                    'checker' => array (
                        'func' => 'avail',
                        'error' => _t ('_ch_groups_form_err_tags'),
                    ),
                    'db' => array (
                        'pass' => 'Tags',
                    ),
                ...
                'categories' => $oCategories->getGroupChooser ('ch_groups', (int)$iProfileId, true),

                // images

                'header_images' => array(
                    'type' => 'block_header',
                    'caption' => _t('_ch_groups_form_header_images'),
                    'collapsable' => true,
                    'collapsed' => false,
                ),
                'thumb' => array(
                    ...
                    'name' => 'thumb',
                    'caption' => _t('_ch_groups_form_caption_thumb_choice'),
                    'info' => _t('_ch_groups_form_info_thumb_choice'),
                    'required' => false,
                    'db' => array (
                        'pass' => 'Int',
                    ),
                ...
                'images_choice' => array(
                    ...
                    'name' => 'images_choice[]',
                    'caption' => _t('_ch_groups_form_caption_images_choice'),
                    'info' => _t('_ch_groups_form_info_images_choice'),
                    'required' => false,
                ),
                'images_upload' => array(
                    'type' => 'custom',
                    ...
                    'name' => 'images_upload[]',
                    'caption' => _t('_ch_groups_form_caption_images_upload'),
                    'info' => _t('_ch_groups_form_info_images_upload'),
                    'required' => false,
                ),
                ...
                'header_videos' => array(
                    'type' => 'block_header',
                    'caption' => _t('_ch_groups_form_header_videos'),
                    'collapsable' => true,
                    'collapsed' => false,
                ),
                'videos_choice' => array(
                    ...
                    'name' => 'videos_choice[]',
                    'caption' => _t('_ch_groups_form_caption_videos_choice'),
                    'info' => _t('_ch_groups_form_info_videos_choice'),
                    'required' => false,
                ),
                'videos_upload' => array(
                    'type' => 'custom',
                    ...
                    'name' => 'videos_upload[]',
                    'caption' => _t('_ch_groups_form_caption_videos_upload'),
                    'info' => _t('_ch_groups_form_info_videos_upload'),
                    'required' => false,
                ),
                ...
                'header_sounds' => array(
                    'type' => 'block_header',
                    'caption' => _t('_ch_groups_form_header_sounds'),
                    'collapsable' => true,
                    'collapsed' => false,
                ),
                'sounds_choice' => array(
                    ...
                    'name' => 'sounds_choice[]',
                    'caption' => _t('_ch_groups_form_caption_sounds_choice'),
                    'info' => _t('_ch_groups_form_info_sounds_choice'),
                    'required' => false,
                ),
                'sounds_upload' => array(
                    'type' => 'custom',
                    ...
                    'name' => 'sounds_upload[]',
                    'caption' => _t('_ch_groups_form_caption_sounds_upload'),
                    'info' => _t('_ch_groups_form_info_sounds_upload'),
                    'required' => false,
                ),
                ...
                'header_files' => array(
                    'type' => 'block_header',
                    'caption' => _t('_ch_groups_form_header_files'),
                    'collapsable' => true,
                    'collapsed' => false,
                ),
                'files_choice' => array(
                    ...
                    'name' => 'files_choice[]',
                    'caption' => _t('_ch_groups_form_caption_files_choice'),
                    'info' => _t('_ch_groups_form_info_files_choice'),
                    'required' => false,
                ),
                'files_upload' => array(
                    'type' => 'custom',
                    ...
                    'name' => 'files_upload[]',
                    'caption' => _t('_ch_groups_form_caption_files_upload'),
                    'info' => _t('_ch_groups_form_info_files_upload'),
                    'required' => false,
                ),
                ...
                'header_privacy' => array(
                    'type' => 'block_header',
                    'caption' => _t('_ch_groups_form_header_privacy'),
                ),
                ...
                'join_confirmation' => array (
                    ...
                    'caption' => _t('_ch_groups_form_caption_join_confirmation'),
                    'info' => _t('_ch_groups_form_info_join_confirmation'),
                    'values' => array(
                        0 => _t('_ch_groups_form_join_confirmation_disabled'),
                        1 => _t('_ch_groups_form_join_confirmation_enabled'),
                    ),
                    'checker' => array (
                        'func' => 'int',
                        'error' => _t ('_ch_groups_form_err_join_confirmation'),
                    ),
                    'db' => array (
                        'pass' => 'Int',
                    ),
