...
class ChProfileCustomizeSearchResult extends ChTemplSearchResult
{
    var $aCurrent = array(
        'name' => 'ch_profile_customize',
        'title' => '_ch_profile_customize',
    ...
    function __construct($sType, $oModule = null)
    {
        ...
        if(!empty($oModule))
            ...
            $this->_oModule = &ChWsbModule::getInstance('ChProfileCustomizeModule');
    ...
    function displaySearchUnit($aData)
    {
        return $this->_oModule->_oTemplate->parseHtmlByName('admin_unit.html', array(
            ...
            'edit_str' => _t('_ch_profile_customize_edit')
        ));
    }
