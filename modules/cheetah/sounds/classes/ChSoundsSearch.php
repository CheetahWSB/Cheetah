...
class ChSoundsSearch extends ChTemplSearchResultSharedMedia
{
    function __construct($sParamName = '', $sParamValue = '', $sParamValue1 = '', $sParamValue2 = '')
    {
        parent::__construct('ChSoundsModule');
        ...
        $this->aCurrent['rss']['title'] = _t('_ch_sounds');

        $this->aAddPartsConfig['favorite']['table'] = 'ch_sounds_favorites';
        $this->oModule = ChWsbModule::getInstance('ChSoundsModule');
        ...
        switch ($sParamName) {
            case 'calendar':
                ...
                $this->aCurrent['title'] = _t('_ch_sounds_caption_browse_by_day') . sprintf("%04u-%02u-%02u", $sParamValue, $sParamValue1, $sParamValue2);
                break;
            case 'top':
            ...
            case 'featured':
                $this->aCurrent['restriction']['featured'] = array(
                    'value'=>'1', 'field'=>'Featured', 'operator'=>'=', 'paramName'=>'ch_sounds_mode'
                );
                break;
            case 'favorited':
    ...
    function serviceGetEntry($iId, $sType)
    {
        ...
        $sqlQuery = "SELECT
            ...
            WHERE a.`ID`='$iId' AND c.`Type`='ch_sounds'";
