...
require_once('ChSoundsSearch.php');

class ChSoundsPageAlbumsMy extends ChWsbPageView
{
    var $oTemplate;
    var $oConfig;
    var $oDb;
    ...
    {
        parent::__construct('ch_sounds_albums_my');
        ...
        $this->oSearch = new ChSoundsSearch('album', $this->aAddParams[1], 'owner', getUsername($this->iOwnerId));

        $this->oAlbum = new ChWsbAlbums('ch_sounds', $this->iOwnerId);
    ...
    function getBlockCode_addObjects ($iBoxId)
    {
        ...
        if (!$this->oSearch->oModule->isAllowedAdd()) {
            ...
            require_once('ChSoundsUploader.php');
            $sLink = CH_WSB_URL_ROOT . $this->oConfig->getBaseUri() . 'albums/my/add_objects/' . $this->aAddParams[1] . '/'. $this->aAddParams[2] . '/' . $this->aAddParams[3];
            ...
            $oUploader = new ChSoundsUploader();
