...
require_once('ChSoundsCmts.php');
require_once('ChSoundsSearch.php');

class ChSoundsPageView extends ChWsbPageView
{
    var $iProfileId;
    var $aFileInfo;
    ...
    {
        parent::__construct('ch_sounds_view');
        ...
        $this->oSearch = new ChSoundsSearch();
    ...
    function getBlockCode_ViewComments ()
    {
        ...
        $oCmtsView = new ChSoundsCmts('ch_' . $this->oConfig->getUri(), $this->aFileInfo['medID']);
