...
('[db_prefix]_activation', 'on', @iKatID, 'Enable auto-activation for files', 'checkbox', '', '', 10, ''),
('[db_prefix]_cat_required', 'on', @iKatID, 'Require category when editing', 'checkbox', '', '', 20, ''),
('category_auto_app_[db_prefix]', 'on', @iKatID, 'Autoapprove categories of files', 'checkbox', '', '', 30, ''),
('[db_prefix]_allowed_exts', '', @iKatID, 'Allowed extensions (leave blank to have all types)', 'digit', '', '', 40, ''),
('[db_prefix]_max_file_size', '32', @iKatID, 'Maximum size of one file (in Megabytes)', 'digit', '', '', 50, ''),
('[db_prefix]_profile_album_name', '{nickname}\'s files', @iKatID, 'Default profile folder name', 'digit', '', '', 60, ''),
('[db_prefix]_mode_index', 'last', @iKatID, 'Default sort on main index page<br /> (if enabled in the template)', 'select', '', '', 70, 'last,popular'),
('[db_prefix]_number_index', '2', @iKatID, 'How many files show on main index page', 'digit', '', '', 80, ''),
('[db_prefix]_number_home', '10', @iKatID, 'How many files show on files home page', 'digit', '', '', 90, ''),
('[db_prefix]_number_all', '10', @iKatID, 'How many files show on browse files page', 'digit', '', '', 100, ''),
('[db_prefix]_number_featured', '4', @iKatID, 'How many files show in featured section', 'digit', '', '', 110, ''),
('[db_prefix]_number_top', '4', @iKatID, 'How many files show in top section', 'digit', '', '', 120, ''),
('[db_prefix]_number_related', '4', @iKatID, 'Number of related files by user', 'digit', '', '', 130, ''),
('[db_prefix]_number_albums_home', '4', @iKatID, 'How many folders show on files home page', 'digit', '', '', 140, ''),
('[db_prefix]_number_albums_browse', '10', @iKatID, 'How many folders show on browse folders page', 'digit', '', '', 150, ''),
('[db_prefix]_number_view_album', '4', @iKatID, 'How many files show on view folder page', 'digit', '', '', 160, ''),
('[db_prefix]_thumb_width', '64', @iKatID, 'Thumbnail width of file', 'digit', '', '', 170, ''),
('[db_prefix]_uploader_switcher', 'html5', @iKatID, 'Available uploaders', 'list', '', '', 180, 'html5,regular');
...
INSERT INTO `sys_page_compose` (`Page`, `PageWidth`, `Desc`, `Caption`, `Column`, `Order`, `Func`, `Content`, `DesignBox`, `ColWidth`, `Visible`, `MinWidth`) VALUES
('index', '1140px', 'Public Files', '_[db_prefix]_public', 0, 0, 'PHP', '$aVisible[] = CH_WSB_PG_ALL;\r\n if ($this->iMemberID > 0) \r\n$aVisible[] = CH_WSB_PG_MEMBERS;\r\n return ChWsbService::call(''files'', ''get_files_block'', array(array(''allow_view''=>$aVisible), array(''menu_top''=>true, ''sorting''=>getParam(''[db_prefix]_mode_index''), ''per_page''=>getParam(''[db_prefix]_number_index''))), ''Search'');', 1, 71.9, 'non,memb', 0),
('profile', '1140px', 'File Albums', '_[db_prefix]_albums', 0, 0, 'PHP', 'return ChWsbService::call(''files'', ''get_profile_albums_block'', array($this->oProfileGen->_iProfileID), ''Search'');', 1, 28.1, 'non,memb', 0);
...
('[db_prefix]', '[db_prefix]_cmts', 'sys_cmts_track', 0, 1, 90, 5, 1, -3, 'none', 0, 1, 0, 'cmt', '[db_prefix]_main', 'ID', 'CommentsCount', 'ChFilesCmts', 'modules/cheetah/files/classes/ChFilesCmts.php'),
('[db_prefix]_albums', '[db_prefix]_cmts_albums', 'sys_cmts_track', 0, 1, 90, 20, 1, -3, 'none', 0, 1, 0, 'cmt', '', '', '', 'ChFilesCmtsAlbums', 'modules/cheetah/files/classes/ChFilesCmtsAlbums.php');
...
VALUES ('[db_prefix]', '[db_prefix]_rating', '[db_prefix]_voting_track', 'gal_', 5, 'vote_send_result', 'CH_PERIOD_PER_VOTE', 1, '', '', '[db_prefix]_main', 'Rate', 'RateCount', 'ID');
...
(@iTMParentId, 'FilesSearch', '_[db_prefix]_top_menu_search', 'searchKeyword.php?type=ch_files', 45, 'non,memb', '', '', '', 1, 1, 1, 'custom', '', 0, '');
...
INSERT INTO `sys_menu_member` SET `Name` = 'ch_files', `Eval` = 'return ChWsbService::call(''files'', ''get_member_menu_item_add_content'');', `Position`='top_extra', `Type` = 'linked_item', `Parent` = IFNULL(@iMemberMenuParent, 0), `Order` = IFNULL(@iMemberMenuOrder, 1);
...
VALUES ('[db_prefix]', '_[db_prefix]', 'ChFilesSearch', 'modules/cheetah/files/classes/ChFilesSearch.php');
...
('[db_prefix]_album', '{evalResult}', 'remove', '', 'getHtmlData(''ajaxy_popup_result_div_{ID}'', ''{moduleUrl}album_delete/{albumUri}'', false, ''post'', true); return false;', 'return (getLoggedId() && ChWsbModule::getInstance(''ChFilesModule'')->isAllowedDeleteAlbum({ID})) ? _t(''_Delete'') : '''';', 1);


INSERT INTO `sys_email_templates` (`Name`, `Subject`, `Body`, `Desc`, `LangID`) VALUES
('t_ch_files_share', 'Check This Out!', '<ch_include_auto:_email_header.html />\r\n\r\n<p><b>Hello</b>,</p>\r\n\r\n<p><SenderNickName> shared a <a href="<MediaUrl>"><MediaType></a> with you!</p>\r\n\r\n<hr>\r\n\r\n<UserExplanation>\r\n\r\n<hr>\r\n\r\n<ch_include_auto:_email_footer.html />', 'File sharing', 0),
('t_ch_files_report', '<SenderNickName> Reported A File', '<ch_include_auto:_email_header.html />\r\n\r\n<p><a href="<MediaUrl>">Reported <MediaType></a></p>\r\n\r\n<hr>\r\n<UserExplanation>\r\n<hr>\r\n\r\n<ch_include_auto:_email_footer.html />', 'File report', 0),
('t_sbs_ch_files_comments', 'New Comments To A File', '<ch_include_auto:_email_header.html />\r\n\r\n<p><b>Dear <RealName></b>,</p>\r\n\r\n<p>The <a href="<ViewLink>">file you subscribed to got new comments</a>!</p>\r\n\r\n<ch_include_auto:_email_footer.html />', 'Subscription: new comments to file', 0);
...
(NULL, '_ch_files', '__shf__ (<a href="modules/?r=files/albums/my/main/">__l_add__</a>)');
...
(2, '[db_prefix]', '_[db_prefix]', '{siteUrl}modules/?r=files/administration', 'Files module by Cheetah', 'save', @iMax+1);
...
('[db_prefix]', '', '', 'return ChWsbService::call(''files'', ''get_subscription_params'', array($arg2, $arg3));'),
('[db_prefix]', 'commentPost', 't_sbs_[db_prefix]_comments', 'return ChWsbService::call(''files'', ''get_subscription_params'', array($arg2, $arg3));');

INSERT INTO `sys_alerts_handlers` (`name`, `eval`) VALUES ('[db_prefix]_profile_delete', 'ChWsbService::call(''files'', ''response_profile_delete'', array($this));');
...
('[db_prefix]', '_ch_files', '0.8', 'auto', 'ChFilesSiteMapsFiles', 'modules/cheetah/files/classes/ChFilesSiteMapsFiles.php', @iMaxOrderSiteMaps, 1),
('[db_prefix]_folders', '_ch_files_albums', '0.8', 'auto', 'ChFilesSiteMapsFolders', 'modules/cheetah/files/classes/ChFilesSiteMapsFolders.php', @iMaxOrderSiteMaps + 1, 1);

-- chart

SET @iMaxOrderCharts = (SELECT MAX(`order`)+1 FROM `sys_objects_charts`);
INSERT INTO `sys_objects_charts` (`object`, `title`, `table`, `field_date_ts`, `field_date_dt`, `query`, `active`, `order`) VALUES
('[db_prefix]', '_ch_files', 'ch_files_main', 'Date', '', '', 1, @iMaxOrderCharts);

-- export

SET @iMaxOrderExports = (SELECT MAX(`order`)+1 FROM `sys_objects_exports`);
INSERT INTO `sys_objects_exports` (`object`, `title`, `class_name`, `class_file`, `order`, `active`) VALUES
('[db_prefix]', '_ch_files', 'ChFilesExport', 'modules/cheetah/files/classes/ChFilesExport.php', @iMaxOrderExports, 1);
