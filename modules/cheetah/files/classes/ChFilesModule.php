...
class ChFilesModule extends ChWsbFilesModule
{
    /**
     * Constructor
     */
    ...
    function isAllowedDownload (&$aFile, $isPerformAction = false)
    {
        ...
        if (!$this->oPrivacy->check('download', $aFile['medID'], $this->_iProfileId))
            return false;
        $this->_defineActions();
        $aCheck = checkAction($this->_iProfileId, CH_FILES_DOWNLOAD, $isPerformAction);
    ...
    function actionAlbumsViewMy ($sParamValue = '', $sParamValue1 = '', $sParamValue2 = '', $sParamValue3 = '')
    {
        ...
        if($sAction !== false) {
            ...
            require_once('ChFilesUploader.php');
            $oUploader = new ChFilesUploader();
