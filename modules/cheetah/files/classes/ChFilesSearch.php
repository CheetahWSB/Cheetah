...
class ChFilesSearch extends ChTemplSearchResult
{
    var $oModule;
    var $oTemplate;
    ...
    function __construct ($sParamName = '', $sParamValue = '', $sParamValue1 = '', $sParamValue2 = '')
    {
        ...
        $this->oModule = ChWsbModule::getInstance('ChFilesModule');
        ...
        switch ($sParamName) {
            ...
            case 'featured':
                $this->aCurrent['restriction']['featured'] = array(
                    'value'=>'1', 'field'=>'Featured', 'operator'=>'=', 'paramName'=>'ch_files_mode'
                );
                break;
            case 'favorited':
    ...
    function serviceGetFileArray ($iId)
    {
        ...
        $sqlQuery = "SELECT a.`ID` as `id`,
                        ...
                        LEFT JOIN `ch_files_types` as d ON d.`Type` = a.`Type`
    ...
    function serviceGetWallPostComment($aEvent)
    {
        ...
        $sTextWallObject = _t('_ch_files_wall_object');
        return array(
            'title' => _t('_ch_files_wall_added_new_comment_title', $sOwner, $sTextWallObject),
            'description' => $aComment['cmt_text'],
            'content' => $sCss . $this->oModule->_oTemplate->parseHtmlByName('modules/cheetah/wall/|timeline_comment.html', array(
        		'mod_prefix' => 'ch_files',
				'cpt_user_name' => $sOwner,
	            'cpt_added_new' => _t('_ch_files_wall_added_new_comment'),
