...
require_once($gConf['dir']['classes'] . 'ChXslTransform.php');
require_once($gConf['dir']['classes'] . 'ChDb.php');
...
require_once($gConf['dir']['classes'] . 'ChMail.php');
...
require_once($gConf['dir']['base'] . 'integrations/' . CH_ORCA_INTEGRATION . '/class.php'); // override Forum class if needed
...
require_once($gConf['dir']['base'] . 'integrations/' . CH_ORCA_INTEGRATION . '/callback.php'); // define custom callback functions
...
switch ($action) {
    ...
    // login functions are replaced by cheetah login/join functions
    /*
        case 'join_form':
