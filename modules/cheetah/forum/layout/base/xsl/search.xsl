    ...
    <xsl:call-template name="box">
        ...
        <xsl:with-param name="content">
            ...
            <xsl:if test="0 = count(sr)">
                <div style="text-align:center;" class="ch-def-font-large ch-def-bc-padding">
...
<xsl:template match="sr">
    <tr>
        <td colspan="3"><div class="ch-def-hr ch-def-margin-sec-top ch-def-margin-sec-bottom"></div></td>
    </tr>
	<tr>
		<td style="width:70%;" class="forum_table_column_first forum_table_fixed_height" valign="top">
            ...
            <div class="forum_search_row">
                ...
                <div id="p_{p/@id}" style="display:none" class="ch-def-padding-sec-top">
                    <xsl:choose>
		...
		<td style="width:15%;" class="forum_table_column_others forum_search_cell_author" valign="top">
            ...
            <xsl:choose>
                <xsl:when test="string-length(u/profile) &gt; 0">
                    <a class="ch-def-margin-sec-left" href="{u/profile}"><xsl:value-of select="u/profile_title" /></a>
                </xsl:when>
                <xsl:otherwise>
                    <span class="ch-def-margin-sec-left"><xsl:value-of select="u/profile_title" /></span>
                </xsl:otherwise>
            </xsl:choose>
