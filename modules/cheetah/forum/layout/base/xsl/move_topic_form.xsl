	...
	<div class="wnd_box">
        ...
        <div class="wnd_content ch-def-padding">
            <form name="move_topic" onsubmit="var x=document.getElementById('js_code').innerHTML; eval(x); return false;">
                ...
                <fieldset class="form_field_row ch-def-margin-bottom"><legend>[L[Forum to move topic to:]]</legend>
                    <select name="forum">
                ...
                <fieldset class="form_field_row ch-def-margin-bottom"><legend>[L[After moving go to:]]</legend>
