        ...
        <xsl:with-param name="content">
            ...
            <div class="ch-def-bc-padding">
                ...
                <div class="forum_reply_button ch-def-margin-top clearfix">
                    <a class="ch-btn" href="javascript:void(0);" onclick="return f.newTopic('0')" icon="{/root/urls/img}btn_icon_new_topic.gif"><i>[L[New Topic]]</i></a>
                </div>
            </div>
...
<xsl:template match="categ">		
    ...
    <tr>
        <td colspan="2"><div class="ch-def-hr ch-def-margin-sec-top ch-def-margin-sec-bottom"></div></td>
    </tr>
    ...
    <tr id="cat{@id}">
		<td>
            ...
            <a class="forum_cat_title ch-def-font-h2 ch-def-margin-sec-left" href="{$rw_cat}{@uri}{$rw_cat_ext}" onclick="return f.selectCat('{@uri}', 'cat{@id}');"><xsl:value-of select="title" disable-output-escaping="yes" /></a>

        </td>
        <td class="forum_table_column_stat ch-def-font-large">
