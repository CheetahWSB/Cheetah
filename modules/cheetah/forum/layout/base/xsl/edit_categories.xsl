	...
	<tr id="cat{@id}">		
        <td colspan="3">
            <div style="position:relative;">
                ...
                <a class="forum_cat_title ch-def-font-h2 ch-def-margin-sec-left" href="javascript:void(0);" onclick="return orca_admin.selectCat('{@uri}', 'cat{@id}');"><xsl:value-of select="title" disable-output-escaping="yes" /></a>
