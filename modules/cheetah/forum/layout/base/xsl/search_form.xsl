        ...
        <div class="ch-def-bc-padding">
            ...
            <form name="new_search" method="post" target="search" onsubmit="return f.search (this.search_text.value, (this.search_type[0].checked ? this.search_type[0].value : this.search_type[1].value), this.search_forum.value, this.search_author.value, (this.search_display[0].checked ? this.search_display[0].value : this.search_display[1].value));">
                ...
                <div class="search_box">
                    ...
                    <div class="search_field ch-def-margin-bottom">
                        <div>[L[Search for:]]</div>
                        <input class="forum_form_field ch-def-font-large ch-def-round-corners-with-border" type="text" name="search_text" size="50" />
                    ...
                    <div class="search_field ch-def-margin-bottom">
                        <div>[L[Forum:]]</div>
                        <span class="search_input">
                            <select class="forum_form_field ch-def-font-large ch-def-round-corners-with-border" name="search_forum"> 
                    ...
                    <div class="search_field ch-def-margin-bottom">
                        <div>[L[Author:]]</div> 
                        <input class="forum_form_field ch-def-font-large ch-def-round-corners-with-border" type="text" name="search_author" size="50" />
                    </div>
