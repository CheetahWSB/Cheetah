...
<xsl:template match="forum">
		...
		<tr cat="{@cat}">
            <td style="width:70%;" class="forum_table_column_first ch-def-padding-sec-top">
                <div style="position:relative;">
                    ...
                    <div class="forum_icon_title_desc">
                        ...
                        <a class="forum_title ch-def-font-h3" href="{$rw_forum}{uri}{$rw_forum_page}0{$rw_forum_ext}" onclick="return f.selectForum('{uri}', 0);"><xsl:value-of select="title" disable-output-escaping="yes" /></a>
