            ...
            <xsl:choose>
                <xsl:when test="count(post)">
                    ...
                    <div class="ch-def-bc-padding">
                        ...
                        <div class="forum_topic_caption_menu ch-def-margin-top ch-def-margin-bottom">
                        ...
                        <table class="forum_table_list forum_posts">
                            <tr>
                               <td><div class="ch-def-hr ch-def-margin-sec-top ch-def-margin-sec-bottom"></div></td>
                            </tr>
                        ...
                        <xsl:if test="forum/id != 0 and topic/id != 0 and 0 = topic/locked">
                            <div class="forum_reply_button ch-def-margin-top clearfix">
                                <a class="ch-btn" href="javascript:void(0);" onclick="return f.postReply('{forum/id}','{topic/id}')" icon="{/root/urls/img}btn_icon_reply.gif"><i>[L[Post Reply]] ›</i></a>
                            </div>
                        </xsl:if>
	...
	<xsl:choose>
		...
		<xsl:otherwise>
			<td id="{@id}">
                ...
                <div class="forum_post_author_panel forum_post_author_panel_{user/role} ch-def-round-corners">
                    ...
                    <div class="forum_post_author">
                        ...
                        <xsl:when test="string-length(user/url) &gt; 0">
                            <b class="forum_post_author_title ch-def-font-h3"><a target="_blank" href="{user/url}" onclick="{user/onclick}"><xsl:value-of select="user/title" /></a></b>
                        </xsl:when>
                        <xsl:otherwise>
                ...
                <div class="forum_post_text ch-def-font-large ch-def-padding-sec-top">
                    <xsl:choose>
                ...
                <xsl:if test="attachments/file">
                    <div class="forum_post_attachments ch-def-font-grayed ch-def-padding-sec-top ch-def-margin-sec-top">
                ...
                <xsl:if test="user/signature and '' != user/signature">
                    <div class="forum_post_signature ch-def-font-grayed ch-def-padding-sec-top ch-def-margin-sec-top">
