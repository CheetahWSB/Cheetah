...
<link type="text/css" rel="stylesheet" href="{/root/url_cheetah}templates/tmpl_{/root/skin_cheetah}/css/general.css" />
<link type="text/css" rel="stylesheet" href="{/root/url_cheetah}templates/tmpl_{/root/skin_cheetah}/css/anchor.css" />

<link type="text/css" rel="stylesheet" href="{/root/url_cheetah}templates/tmpl_{/root/skin_cheetah}/menu/css/top_menu.css" />

<link type="text/css" rel="stylesheet" href="{/root/url_cheetah}plugins/tiny_mce/themes/advanced/css/editor_ui.css" />
...
<script language="javascript" type="text/javascript" src="{/root/url_cheetah}inc/js/functions.js"></script>

<script language="javascript" type="text/javascript" src="{/root/url_cheetah}plugins/jquery/jquery.js"></script>
<script language="javascript" type="text/javascript" src="{/root/url_cheetah}plugins/jquery/jquery.jfeed.js"></script>
<script language="javascript" type="text/javascript" src="{/root/url_cheetah}inc/js/jquery.dolRSSFeed.js"></script>
<script language="javascript" type="text/javascript" src="{/root/url_cheetah}inc/js/jquery.webForms.js"></script>

<script type="text/javascript" language="javascript">        
        var site_url = '<xsl:value-of select="url_cheetah" />';
