...
ChEditor.prototype.setName = function (i)
{
	this._name = i;
}

ChEditor.prototype.init = function ()
{
...
ChEditor.prototype.initMenu = function ()
{
	var a = {
				0:{'left':0, 'make':'Bold'},
...
ChEditor.prototype.makeBold = function ()
{
	this._el.focus();
	this._doc.execCommand('bold', false, null);
}

ChEditor.prototype.makeItalic = function ()
{
	this._el.focus();
	this._doc.execCommand('italic', false, null);
}

ChEditor.prototype.makeUnderline = function ()
{
	this._el.focus();
	this._doc.execCommand('underline', false, null);
}

ChEditor.prototype.makeBulletedList = function ()
{
	this._el.focus();
	this._doc.execCommand('InsertUnorderedList', false, null);
}

ChEditor.prototype.makeNumberedList = function ()
{
	this._el.focus();
	this._doc.execCommand('InsertOrderedList', false, null);
}

ChEditor.prototype.makeOutdent = function ()
{
	this._el.focus();
	this._doc.execCommand('outdent', false, null);
}

ChEditor.prototype.makeIndent = function ()
{
	this._el.focus();
...
ChEditor.prototype.makeRemoveFormat = function ()
{
	this._el.focus();
...
ChEditor.prototype.makeCode = function ()
{
...
ChEditor.prototype.makeFont = function ()
{
	this._el.focus();
	this._doc.execCommand('FontName', false, 'Arial');
}

ChEditor.prototype.makeHeading = function (h)
{
	this._el.focus();
...
ChEditor.prototype.getText = function ()
{
	if (this._el.contentDocument)
	{
...
ChEditor.prototype.setText = function (s)
{
	if (this._el.contentDocument)
	{
...
ChEditor.prototype._get_selection_bounds = function (editor_window){
...
// tag_name - tag name
ChEditor.prototype._find_tags_in_subtree = function (bounds, tag_name, stage, second){
...
ChEditor.prototype._closest_parent_by_tag_name = function (node, tag_name) {
...
ChEditor.prototype._get_selected_tags = function (editor_window, tag_name){
...
ChEditor.prototype._clean_nodes = function (nodes, class_name){
   if(!nodes) return
...
ChEditor.prototype._format_pre_moz = function (){
...
ChEditor.prototype._format_pre_ie = function (){
...
ChEditor.prototype._format_inline = function (tag_name, class_name){
...
ChEditor.prototype._wysiwyg_format_block = function (class_name){
