...
$path = CH_DIRECTORY_PATH_ROOT . 'modules/cheetah/forum/'; // path to orca files
...
$gConf['date_format'] = getLocaleFormat(CH_WSB_LOCALE_DATE, CH_WSB_LOCALE_DB); // time/date format
...
$gConf['dir']['xml']         = $path . 'integrations/' . CH_ORCA_INTEGRATION . '/'; // path to integratiom directory
...
$gConf['dir']['editor']      = CH_DIRECTORY_PATH_PLUGINS . 'tiny_mce/'; // path to javascript editor
...
$gConf['db']['prefix'] = 'ch_';       // tables names prefix
