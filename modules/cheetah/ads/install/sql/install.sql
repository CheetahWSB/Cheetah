...
-- PQ statistics
INSERT INTO `sys_account_custom_stat_elements` (`ID`, `Label`, `Value`) VALUES(NULL, '_ch_ads_Ads', '__mad__ (<a href="__site_url__ads/my_page/add/">__l_add__</a>)');
...
(NULL, 2, 'Ads', '_sys_module_ads', '{siteUrl}modules/cheetah/ads/post_mod_ads.php', 'Administrator can manage ads categories, subcategories, etc.', 'money', '', '', @iExtOrd+1);
...
('ads', '[db_prefix]_cmts', 'sys_cmts_track', 0, 1, 90, 5, 1, -3, 'none', 0, 1, 0, 'cmt', '[db_prefix]_main', 'ID', 'CommentsCount', 'ChAdsCmts', 'modules/cheetah/ads/classes/ChAdsCmts.php');
...
('ch_ads_max_live_days', '30', @iGlCategID, 'How long can Classifieds live (days)', 'digit', '', '', NULL),
('ch_ads_enable_paid', 'on', @iGlCategID, 'Enable Ability to work with Buy Now button in Ads', 'checkbox', '', '', NULL),
('ch_ads_auto_approving', 'on', @iGlCategID, 'Automatic advertisements activation after adding', 'checkbox', '', '', NULL),
...
(NULL, 'index', '1140px', 'Classifieds', '_ch_ads_Ads', 0, 0, 'PHP', 'return ChWsbService::call(''ads'', ''ads_index_page'');', 1, 28.1, 'non,memb', 0),
(NULL, 'member', '1140px', 'Classifieds', '_ch_ads_Ads', 0, 0, 'PHP', 'return ChWsbService::call(''ads'', ''ads_profile_page'', array($this->iMember));', 1, 28.1, 'non,memb', 0),
(NULL, 'profile', '1140px', 'Classifieds', '_ch_ads_Ads', 0, 0, 'PHP', 'return ChWsbService::call(''ads'', ''ads_profile_page'', array($this->oProfileGen->_iProfileID));', 1, 28.1, 'non,memb', 0),

(NULL, 'ads', '1140px', '', '_Description', 1, 0, 'AdDescription', '', 1, 71.9, 'non,memb', 0),
(NULL, 'ads', '1140px', '', '_ch_ads_Ad_photos', 1, 1, 'AdPhotos', '', 1, 71.9, 'non,memb', 0),
(NULL, 'ads', '1140px', '', '_Comments', 1, 2, 'ViewComments', '', 1, 71.9, 'non,memb', 0),
(NULL, 'ads', '1140px', '', '_Info', 2, 0, 'AdInfo', '', 1, 28.1, 'non,memb', 0),
(NULL, 'ads', '1140px', '', '_ch_ads_Custom_Values', 2, 1, 'AdCustomInfo', '', 1, 28.1, 'non,memb', 0),
...
(NULL, 'ads', '1140px', '', '_ch_ads_Users_other_listing', 2, 5, 'UserOtherAds', '', 1, 28.1, 'non,memb', 0);
...
('ads_home', '1140px', '', '', 2, 0, 0, 28.1, 0, 'non,memb', '_ch_ads_last_ads', 'last'),
('ads_home', '1140px', '', '', 1, 0, 1, 71.9, 0, 'non,memb', '_ch_ads_last_featured', 'featured'),
('ads_home', '1140px', '', '', 1, 1, 0, 71.9, 0, 'non,memb', '_ch_ads_Categories', 'categories');
...
('ads', '1140px', 'Ad''s Location', '_Location', 2, IFNULL(@iMaxOrder, 0), 'PHP', 'return ChWsbService::call(''wmap'', ''location_block'', array(''ads'', $this->oAds->oCmtsView->getId()));', 1, 28.1, 'non,memb', 0);

SET @iMaxOrder = (SELECT `Order` + 1 FROM `sys_page_compose` WHERE `Page` = 'ads_home' AND `Column` = 1 ORDER BY `Order` DESC LIMIT 1);
INSERT INTO `sys_page_compose` (`Page`, `PageWidth`, `Desc`, `Caption`, `Column`, `Order`, `Func`, `Content`, `DesignBox`, `ColWidth`, `Visible`, `MinWidth`) VALUES
('ads_home', '1140px', 'Map', '_Map', 1, IFNULL(@iMaxOrder, 0), 'PHP', 'return ChWsbService::call(''wmap'', ''homepage_part_block'', array (''ads''));', 1, 71.9, 'non,memb', 0);
...
('cls', 'ch_ads_Ads', 'modules/cheetah/ads/classifieds.php?action=show_all_ads', 'SELECT COUNT(`ID`) FROM `[db_prefix]_main` WHERE `Status`=''active'' AND UNIX_TIMESTAMP() - `[db_prefix]_main`.`LifeTime`*24*60*60 < `[db_prefix]_main`.`DateTime`', 'modules/cheetah/ads/post_mod_ads.php', 'SELECT COUNT(`ID`) FROM `[db_prefix]_main` WHERE `Status`=''new'' AND UNIX_TIMESTAMP() - `[db_prefix]_main`.`LifeTime`*24*60*60 < `[db_prefix]_main`.`DateTime`', 'money', @iStatSiteOrder);

-- search objects
INSERT INTO `sys_objects_search` (`ID`, `ObjectName`, `Title`, `ClassName`, `ClassPath`) VALUES(NULL, 'ch_ads', '_ch_ads_Ads', 'ChAdsSearchUnit', 'modules/cheetah/ads/classes/ChAdsSearchUnit.php');

-- tag objects
INSERT INTO `sys_objects_tag` (`ID`, `ObjectName`, `Query`, `PermalinkParam`, `EnabledPermalink`, `DisabledPermalink`, `LangKey`) VALUES(NULL, 'ad', 'SELECT `Tags` FROM `[db_prefix]_main` WHERE `ID` = {iID} AND `status` = ''active''', 'permalinks_module_ads', 'ads/tag/{tag}', 'modules/cheetah/ads/classifieds_tags.php?tag={tag}', '_ch_ads_Ads');
...
(NULL, 0, 'Ads', '_ch_ads_Ads', 'modules/cheetah/ads/classifieds.php?Browse=1|modules/cheetah/ads/classifieds.php?action=show_calendar_ads&date=|modules/cheetah/ads/classifieds_tags.php?tag=|ads/tag/|modules/cheetah/ads/classifieds.php?bClassifiedID=|ads/cat/|modules/cheetah/ads/classifieds.php?bSubClassifiedID=|ads/subcat/', @iTopMenuLastOrder, 'non,memb', '', '', '', 1, 1, 1, 'top', 'money', 'money', 1, '');
...
(NULL, @menu_id, 'Ads Tags', '_Tags', 'modules/cheetah/ads/classifieds.php?action=tags', 4, 'non,memb', '', '', '', 1, 1, 1, 'custom', '', 0, ''),
(NULL, @menu_id, 'Top Rated Ads', '_ch_ads_Top_Rated', 'modules/cheetah/ads/classifieds.php?action=show_top_rated', 2, 'non,memb', '', '', '', 1, 1, 1, 'custom', '', 0, ''),
(NULL, @menu_id, 'Ads Search', '_Search', 'searchKeyword.php?type=ch_ads|modules/cheetah/ads/classifieds.php?FilterCountry=', 8, 'non,memb', '', '', '', 1, 1, 1, 'custom', '', 0, ''),
(NULL, @menu_id, 'Ads Featured', '_ch_ads_Featured', 'modules/cheetah/ads/classifieds.php?action=show_featured', 7, 'non,memb', '', '', '', 1, 1, 1, 'custom', '', 0, ''),
(NULL, @menu_id, 'All Ads', '_ch_ads_All_ads', 'modules/cheetah/ads/classifieds.php?action=show_all_ads', 1, 'non,memb', '', '', '', 1, 1, 1, 'custom', '', 0, ''),
(NULL, @menu_id, 'Ads Home', '_ch_ads_Ads_Home', 'modules/cheetah/ads/classifieds.php?Browse=1', 0, 'non,memb', '', '', '', 1, 1, 1, 'custom', '', 0, ''),
(NULL, 0, 'Ad View', '_ch_ads_Ads', 'modules/cheetah/ads/classifieds.php?ShowAdvertisementID=|ads/entry/', 0, 'non,memb', '', '', '', 1, 1, 1, 'system', 'money', 0, '');
...
INSERT INTO `sys_menu_member` SET `Name` = 'ch_ads', `Eval` = 'return ChWsbService::call(''ads'', ''get_member_menu_item_add_content'');', `Position`='top_extra', `Type` = 'linked_item', `Parent` = IFNULL(@iMemberMenuParent, 0), `Order` = IFNULL(@iMemberMenuOrder, 1);

-- vote objects
INSERT INTO `sys_objects_vote` (`ID`, `ObjectName`, `TableRating`, `TableTrack`, `RowPrefix`, `MaxVotes`, `PostName`, `IsDuplicate`, `IsOn`, `className`, `classFile`, `TriggerTable`, `TriggerFieldRate`, `TriggerFieldRateCount`, `TriggerFieldId`, `OverrideClassName`, `OverrideClassFile`) VALUES(NULL, 'ads', '[db_prefix]_rating', '[db_prefix]_voting_track', 'ads_', 5, 'vote_send_result', 'CH_PERIOD_PER_VOTE', 1, '', '', '[db_prefix]_main', 'Rate', 'RateCount', 'ID', '', '');

-- permalinks
INSERT INTO `sys_permalinks`(`standard`, `permalink`, `check`) VALUES
('modules/cheetah/ads/classifieds.php?Browse=1', 'ads/', 'permalinks_module_ads'),
('modules/cheetah/ads/classifieds.php?action=show_calendar', 'ads/calendar/', 'permalinks_module_ads'),
('modules/cheetah/ads/classifieds.php?action=show_categories', 'ads/categories/', 'permalinks_module_ads'),
('modules/cheetah/ads/classifieds.php?action=tags', 'ads/tags/', 'permalinks_module_ads'),
('modules/cheetah/ads/classifieds.php?action=show_all_ads', 'ads/all_ads/', 'permalinks_module_ads'),
('modules/cheetah/ads/classifieds.php?action=show_top_rated', 'ads/top_ads/', 'permalinks_module_ads'),
('modules/cheetah/ads/classifieds.php?action=show_popular', 'ads/popular_ads/', 'permalinks_module_ads'),
('modules/cheetah/ads/classifieds.php?action=show_featured', 'ads/featured_ads/', 'permalinks_module_ads'),
('modules/cheetah/ads/classifieds.php?action=my_page', 'ads/my_page/', 'permalinks_module_ads'),
('modules/cheetah/ads/classifieds.php?UsersOtherListing=1&IDProfile=', 'ads/member_ads/', 'permalinks_module_ads');

INSERT INTO `sys_permalinks`(`standard`, `permalink`, `check`) VALUES
('modules/?r=ads/search/', 'm/ads/search/', 'permalinks_module_ads');

-- Alerts Handler and Events
INSERT INTO `sys_alerts_handlers` VALUES (NULL, 'ch_ads_profile_delete', '', '', 'ChWsbService::call(''ads'', ''response_profile_delete'', array($this));');
SET @iHandler := LAST_INSERT_ID();
INSERT INTO `sys_alerts` VALUES (NULL , 'profile', 'delete', @iHandler);

INSERT INTO `sys_alerts_handlers` VALUES (NULL, 'ch_ads_map_install', '', '', 'if (''wmap'' == $this->aExtras[''uri''] && $this->aExtras[''res''][''result'']) ChWsbService::call(''ads'', ''map_install'');');
SET @iHandler := LAST_INSERT_ID();
...
('ads', 'comment', '_ch_ads_privacy_comment', '3'),
('ads', 'rate', '_ch_ads_privacy_rate', '3'),
('ads', 'view', '_ch_ads_privacy_view', '3');

-- actions
INSERT INTO `sys_objects_actions` (`ID`, `Caption`, `Icon`, `Url`, `Script`, `Eval`, `Order`, `Type`, `bDisplayInSubMenuHeader`) VALUES

(NULL, '_ch_ads_Add', 'plus', '{evalResult}', '', 'if ({only_menu} == 1)\r\n    if (getParam(''permalinks_module_ads'') == ''on'') return ''ads/my_page/add/'';\r\n    else return ''modules/cheetah/ads/classifieds.php?action=my_page&mode=add'';\r\nelse\r\n    return null;\r\n', 1, 'ch_ads', 1),
(NULL, '_ch_ads_My_Ads', 'money', '{evalResult}', '', 'if ({only_menu} == 1)\r\n    if (getParam(''permalinks_module_ads'') == ''on'') return ''ads/my_page/'';\r\n    else return ''modules/cheetah/ads/classifieds.php?action=my_page'';\r\nelse\r\n    return null;\r\n', 2, 'ch_ads', 1),

(NULL, '{evalResult}', 'shopping-cart', '', 'document.forms[''BuyNowForm''].submit();', '$bBnp = getParam(''ch_ads_enable_paid'');\r\nif ({visitor_id} > 0 && {visitor_id} != {owner_id} && $bBnp==''on'') {\r\nreturn _t(''_ch_ads_Buy_Now'');\r\n}\r\nelse\r\nreturn null;', 4, 'ch_ads', 0),
(NULL, '{evalResult}', 'envelope', '', 'document.forms[''post_pm''].submit();', 'if ({visitor_id} > 0 && {visitor_id} != {owner_id}) {\r\nreturn _t(''_Send Message'');\r\n}\r\nelse\r\nreturn null;', 5, 'ch_ads', 0),
(NULL, '_Edit', 'edit', '{evalResult}', '', 'if (({visitor_id} > 0 && {visitor_id} == {owner_id}) || ({admin_mode}==true)) {\r\n    return (getParam(''permalinks_module_ads'') == ''on'') ? ''ads/my_page/edit/{ads_id}'' : ''modules/cheetah/ads/classifieds.php?action=my_page&mode=add&EditPostID={ads_id}'';\r\n} else return null;', 6, 'ch_ads', 0),
(NULL, '{evalResult}', 'remove', '', 'iDelAdID = {ads_id}; if (confirm(''{sure_label}'')) { $(''#DeleteAdvertisementID'').val(iDelAdID);document.forms.command_delete_advertisement.submit(); }', '$oModule = ChWsbModule::getInstance(''ChAdsModule'');\r\n if (({visitor_id} > 0 && {visitor_id} == {owner_id}) || ({admin_mode}==true) || $oModule->isAllowedDelete({owner_id})) {\r\nreturn _t(''_Delete'');\r\n}\r\nelse\r\nreturn null;', 7, 'ch_ads', 0),
(NULL, '_ch_ads_RSS', 'rss', 'rss_factory.php?action=ads&pid={owner_id}', '', '', 8, 'ch_ads', 0),
(NULL, '{evalResult}', 'check-circle-o', '', '$(''#ActivateAdvertisementID'').val(''{ads_id}''); $(''#ActType'').val(''{ads_act_type}''); document.forms.command_activate_advertisement.submit(); return false;', 'if (!isAdmin() && !isModerator())\r\nreturn null;\r\nif (''{ads_status}''!=''active'') {\r\nreturn _t(''_ch_ads_Activate'');\r\n}\r\nelse\r\nreturn _t(''_ch_ads_DeActivate'');', 9, 'ch_ads', 0),
(NULL, '{evalResult}', 'star-o', '{ads_entry_url}&do=cfs', '', '$iAdsFeature = (int)''{ads_featured}'';\r\nif ({admin_mode}==true) {\r\nreturn ($iAdsFeature==1) ? _t(''_ch_ads_De-Feature_it'') : _t(''_ch_ads_Feature_it'');\r\n}\r\nelse\r\nreturn null;', 10, 'ch_ads', 0),
(NULL, '{sbs_ads_title}', 'paperclip', '', '{sbs_ads_script}', '', 11, 'ch_ads', 0),
(NULL, '{TitleShare}', 'share-square-o', '', 'showPopupAnyHtml (''{BaseUri}share_popup/{ads_id}'');', '', '12', 'ch_ads', 0),
(NULL, '{repostCpt}', 'repeat', '', '{repostScript}', '', 13, 'ch_ads', 0);

-- subscriptions
INSERT INTO `sys_sbs_types`(`unit`, `action`, `template`, `params`) VALUES
('ads', '', '', 'return ChWsbService::call(''ads'', ''get_subscription_params'', array($arg2, $arg3));'),
('ads', 'commentPost', 't_sbsAdsComments', 'return ChWsbService::call(''ads'', ''get_subscription_params'', array($arg2, $arg3));');

-- email templates
INSERT INTO `sys_email_templates`(`Name`, `Subject`, `Body`, `Desc`, `LangID`) VALUES
('t_sbsAdsComments', 'New Comments To An Ad', '<ch_include_auto:_email_header.html />\r\n\r\n<p><b>Dear <RealName></b>,</p>\r\n\r\n<p>The <a href="<ViewLink>">ad you subscribed to got new comments</a>!</p>\r\n\r\n<ch_include_auto:_email_footer.html />', 'Subscription: new comments to ad', 0),
('t_BuyNow', 'Your Purchase', '<ch_include_auto:_email_header.html />\r\n\r\nItem: <a href="<ShowAdvLnk>"><Subject></a><br/><br/>\r\n\r\nSeller name: <NickName><br/>\r\nSeller email: <EmailS><br/><br/>\r\n\r\nBuyer name: <NickNameB><br/>\r\nBuyer email: <EmailB><br/><br/>\r\n\r\nPrice details: <sCustDetails><br/><br/>\r\n\r\nContact the <Who> directly to arrange payment and delivery. \r\n\r\n<ch_include_auto:_email_footer.html />', 'Purchase notification', 0),
('t_BuyNowS', 'Your Item Was Purchased', '<ch_include_auto:_email_header.html />\r\n\r\nItem: <a href="<ShowAdvLnk>"><Subject></a><br/><br/>\r\n\r\nSeller name: <NickName><br/>\r\nSeller email: <EmailS><br/><br/>\r\n\r\nBuyer name: <NickNameB><br/>\r\nBuyer email: <EmailB><br/><br/><br/>\r\n\r\nPrice details: <sCustDetails><br/><br/>\r\n\r\nContact the <Who> directly to arrange payment and delivery. \r\n\r\n<ch_include_auto:_email_footer.html />', 'Seller notification about a purchase', 0);
...
('ch_ads', '_ch_ads_Ads', '0.8', 'auto', 'ChAdsSiteMaps', 'modules/cheetah/ads/classes/ChAdsSiteMaps.php', @iMaxOrderSiteMaps, 1);

-- chart

SET @iMaxOrderCharts = (SELECT MAX(`order`)+1 FROM `sys_objects_charts`);
INSERT INTO `sys_objects_charts` (`object`, `title`, `table`, `field_date_ts`, `field_date_dt`, `query`, `active`, `order`) VALUES
('ch_ads', '_ch_ads_Ads', 'ch_ads_main', 'DateTime', '', '', 1, @iMaxOrderCharts);
