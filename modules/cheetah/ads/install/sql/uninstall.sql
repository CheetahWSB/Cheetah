...
-- PQ statistics
DELETE FROM `sys_account_custom_stat_elements` WHERE `Label` = '_ch_ads_Ads';
...
DELETE FROM `sys_page_compose` WHERE `Page`='index' AND `Desc`='Classifieds' AND `Caption`='_ch_ads_Ads' AND `Func`='PHP';
DELETE FROM `sys_page_compose` WHERE `Page`='member' AND `Desc`='Classifieds' AND `Caption`='_ch_ads_Ads' AND `Func`='PHP';
DELETE FROM `sys_page_compose` WHERE `Page`='profile' AND `Desc`='Classifieds' AND `Caption`='_ch_ads_Ads' AND `Func`='PHP';
...
-- search objects
DELETE FROM `sys_objects_search` WHERE `ClassName`='ChAdsSearchUnit';

-- tag objects
DELETE FROM `sys_objects_tag` WHERE `ObjectName`='ad' AND `LangKey`='_ch_ads_Ads';
...
SET @iHandler := (SELECT `id` FROM `sys_alerts_handlers` WHERE `name` = 'ch_ads_profile_delete' LIMIT 1);
DELETE FROM `sys_alerts` WHERE `handler_id` = @iHandler;
DELETE FROM `sys_alerts_handlers` WHERE `id` = @iHandler;

SET @iHandler := (SELECT `id` FROM `sys_alerts_handlers` WHERE `name` = 'ch_ads_map_install' LIMIT 1);
DELETE FROM `sys_alerts` WHERE `handler_id` = @iHandler;
DELETE FROM `sys_alerts_handlers` WHERE `id` = @iHandler;
...
-- actions
DELETE FROM `sys_objects_actions` WHERE `Type` = 'ch_ads';
...
-- sitemap
DELETE FROM `sys_objects_site_maps` WHERE `object` = 'ch_ads';

-- chart
DELETE FROM `sys_objects_charts` WHERE `object` = 'ch_ads';
