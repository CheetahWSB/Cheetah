...
(@iTMParentId, 'NewsSearch', '_news_search_top_menu_sitem', 'searchKeyword.php?type=ch_news', 8, 'non,memb', '', '', '', 1, 1, 1, 'custom', '', 0, ''),
...
(2, 'ch_news', '_news_admin_menu_sitem', '{siteUrl}modules/?r=news/admin/', 'For managing news', 'bullhorn', '', '', @iOrder+1);
...
('category_auto_app_ch_news', 'on', 0, 'Autoapprove for categories', 'checkbox', '', '', 0),
...
('ch_news', '[db_prefix]comments', '[db_prefix]comments_track', 0, 1, 90, 10, 1, -3, 'none', 0, 1, 0, 'cmt', '[db_prefix]entries', 'id', 'cmts_count', 'ChNewsCmts', 'modules/cheetah/news/classes/ChNewsCmts.php');
...
('ch_news', '[db_prefix]voting', '[db_prefix]voting_track', 'news_', 5, 'vote_send_result', 'CH_PERIOD_PER_VOTE', 1, '', '', '[db_prefix]entries', 'rate', 'rate_count', 'id', 'ChNewsVoting', 'modules/cheetah/news/classes/ChNewsVoting.php');

INSERT INTO `sys_objects_tag` (`ObjectName`, `Query`, `PermalinkParam`, `EnabledPermalink`, `DisabledPermalink`, `LangKey`) VALUES
('ch_news', 'SELECT `tags` FROM `[db_prefix]entries` WHERE `id`={iID} AND `status`=0', 'permalinks_module_news', 'm/news/tag/{tag}', 'modules/?r=news/tag/{tag}', '_news_lcaption_tags');

INSERT INTO `sys_objects_categories` (`ObjectName`, `Query`, `PermalinkParam`, `EnabledPermalink`, `DisabledPermalink`, `LangKey`)
VALUES ('ch_news', 'SELECT `categories` FROM `[db_prefix]entries` WHERE `id`=''{iID}'' AND `status`=''0''', 'permalinks_module_news', 'm/news/category/{tag}', 'modules/?r=news/category/{tag}', '_news_lcaption_categories');

INSERT INTO `sys_categories` (`Category`, `ID`, `Type`, `Owner`, `Status`) VALUES
('Default', '0', 'ch_news', '0', 'active'),
('Cheetah Products', '0', 'ch_news', '0', 'active'),
('Some Useful Info', '0', 'ch_news', '0', 'active');

INSERT INTO `sys_objects_search` (`ObjectName`, `Title`, `ClassName`, `ClassPath`) VALUES
('ch_news', '_news_lcaption_search_object', 'ChNewsSearchResult', 'modules/cheetah/news/classes/ChNewsSearchResult.php');

INSERT INTO `sys_objects_views`(`name`, `table_track`, `period`, `trigger_table`, `trigger_field_id`, `trigger_field_views`, `is_on`) VALUES
('ch_news', '[db_prefix]views_track', 86400, '[db_prefix]entries', 'id', 'view_count', 1);
...
('index', '1140px', 'Show list of featured news', '_news_bcaption_featured', 0, 0, 'PHP', 'return ChWsbService::call(\'news\', \'featured_block_index\', array(0, 0, false));', 1, 28.1, 'non,memb', 0),
('index', '1140px', 'Show list of latest news', '_news_bcaption_latest', 0, 0, 'PHP', 'return ChWsbService::call(\'news\', \'archive_block_index\', array(0, 0, false));', 1, 71.9, 'non,memb', 0),
('member', '1140px', 'Show list of featured news', '_news_bcaption_featured', 0, 0, 'PHP', 'return ChWsbService::call(\'news\', \'featured_block_member\', array(0, 0, false));', 1, 71.9, 'memb', 0),
('member', '1140px', 'Show list of latest news', '_news_bcaption_latest', 0, 0, 'PHP', 'return ChWsbService::call(\'news\', \'archive_block_member\', array(0, 0, false));', 1, 71.9, 'memb', 0),
...
('{sbs_news_title}', 'paperclip', '', '{sbs_news_script}', '', 1, 'ch_news', 0),
('{del_news_title}', 'remove', '', '{del_news_script}', '', 2, 'ch_news', 0),
('{share_news_title}', 'share-square-o', '', '{share_news_script}', '', 3, 'ch_news', 0);

INSERT INTO `sys_sbs_types`(`unit`, `action`, `template`, `params`) VALUES
('ch_news', '', '', 'return ChWsbService::call(\'news\', \'get_subscription_params\', array($arg1, $arg2, $arg3));'),
('ch_news', 'commentPost', 't_sbsNewsComments', 'return ChWsbService::call(\'news\', \'get_subscription_params\', array($arg1, $arg2, $arg3));');

INSERT INTO `sys_email_templates`(`Name`, `Subject`, `Body`, `Desc`, `LangID`) VALUES
('t_sbsNewsComments', 'New Comments To A News Post', '<ch_include_auto:_email_header.html />\r\n\r\n<p><b>Dear <RealName></b>,</p>\r\n\r\n<br /><p>The <a href="<ViewLink>">news post you subscribed to got new comments!</a></p>\r\n\r\n<ch_include_auto:_email_footer.html />', 'Subscription: new comments to file', 0);
...
('ch_news', '*/5 * * * *', 'ChNewsCron', 'modules/cheetah/news/classes/ChNewsCron.php', '');
...
('ch_news', 'homepage', '_news_bcaption_view_main', '{site_url}modules/cheetah/news/templates/base/images/icons/mobile_icon.png', 100, '{xmlrpc_url}r.php?url=modules%2F%3Fr%3Dnews%2Fmobile_latest_entries%2F&user={member_username}&pwd={member_password}', '', '', @iMaxOrderHomepage, 1);
...
('ch_news', '_news_sitemap', '0.8', 'auto', 'ChNewsSiteMaps', 'modules/cheetah/news/classes/ChNewsSiteMaps.php', @iMaxOrderSiteMaps, 1);

-- chart
SET @iMaxOrderCharts = (SELECT MAX(`order`)+1 FROM `sys_objects_charts`);
INSERT INTO `sys_objects_charts` (`object`, `title`, `table`, `field_date_ts`, `field_date_dt`, `query`, `active`, `order`) VALUES
('ch_news', '_news_chart', 'ch_news_entries', 'when', '', '', 1, @iMaxOrderCharts);

-- export
SET @iMaxOrderExports = (SELECT MAX(`order`)+1 FROM `sys_objects_exports`);
INSERT INTO `sys_objects_exports` (`object`, `title`, `class_name`, `class_file`, `order`, `active`) VALUES
('ch_news', '_news', 'ChNewsExport', 'modules/cheetah/news/classes/ChNewsExport.php', @iMaxOrderExports, 1);
