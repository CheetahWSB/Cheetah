...
(2, 'ch_feedback', '_feedback_admin_menu_sitem', '{siteUrl}modules/?r=feedback/admin/', 'For managing member''s feedback', 'thumbs-up', '', '', @iOrder+1);
...
('ch_feedback', '[db_prefix]comments', '[db_prefix]comments_track', 0, 1, 90, 20, 1, -3, 'none', 0, 1, 0, 'cmt', '[db_prefix]entries', 'id', 'cmts_count', 'ChFdbCmts', 'modules/cheetah/feedback/classes/ChFdbCmts.php');
...
('ch_feedback', '[db_prefix]voting', '[db_prefix]voting_track', 'fdb_', 5, 'vote_send_result', 'CH_PERIOD_PER_VOTE', 1, '', '', '[db_prefix]entries', 'rate', 'rate_count', 'id', 'ChFdbVoting', 'modules/cheetah/feedback/classes/ChFdbVoting.php');

INSERT INTO `sys_objects_tag` (`ObjectName`, `Query`, `PermalinkParam`, `EnabledPermalink`, `DisabledPermalink`, `LangKey`) VALUES
('ch_feedback', 'SELECT `tags` FROM `[db_prefix]entries` WHERE `id`={iID} AND `status`=0', 'permalinks_module_feedback', 'm/feedback/tag/{tag}', 'modules/?r=feedback/tag/{tag}', '_feedback_lcaption_tags_object');

INSERT INTO `sys_objects_search` (`ObjectName`, `Title`, `ClassName`, `ClassPath`) VALUES
('ch_feedback', '_feedback_lcaption_search_object', 'ChFdbSearchResult', 'modules/cheetah/feedback/classes/ChFdbSearchResult.php');
...
('index', '1140px', 'Feedback from your customers', '_feedback_bcaption_index', 0, 0, 'PHP', 'return ChWsbService::call(\'feedback\', \'archive_block_index\', array(0, 0, false));', 1, 71.9, 'non,memb', 0),
...
('{sbs_feedback_title}', 'paperclip', '', '{sbs_feedback_script}', '', 1, 'ch_feedback', 0),
('{del_feedback_title}', 'remove', '', '{del_feedback_script}', '', 2, 'ch_feedback', 0);

INSERT INTO `sys_sbs_types`(`unit`, `action`, `template`, `params`) VALUES
('ch_feedback', '', '', 'return ChWsbService::call(\'feedback\', \'get_subscription_params\', array($arg1, $arg2, $arg3));'),
('ch_feedback', 'commentPost', 't_sbsFeedbackComments', 'return ChWsbService::call(\'feedback\', \'get_subscription_params\', array($arg1, $arg2, $arg3));');

INSERT INTO `sys_email_templates`(`Name`, `Subject`, `Body`, `Desc`, `LangID`) VALUES
('t_sbsFeedbackComments', 'New Comments To A Feedback Post', '<ch_include_auto:_email_header.html />\r\n\r\n<p><b>Dear <RealName></b>,</p>\r\n\r\n<p>The <a href="<ViewLink>">feedback post you subscribed to got new comments</a>!</p>\r\n\r\n<ch_include_auto:_email_footer.html />', 'Subscription: new comments to feedback', 0);
...
('ch_feedback', '_feedback_sitemap', '0.8', 'auto', 'ChFdbSiteMaps', 'modules/cheetah/feedback/classes/ChFdbSiteMaps.php', @iMaxOrderSiteMaps, 1);

-- chart
SET @iMaxOrderCharts = (SELECT MAX(`order`)+1 FROM `sys_objects_charts`);
INSERT INTO `sys_objects_charts` (`object`, `title`, `table`, `field_date_ts`, `field_date_dt`, `query`, `active`, `order`) VALUES
('ch_feedback', '_feedback_chart', 'ch_fdb_entries', 'date', '', '', 1, @iMaxOrderCharts);

-- export
SET @iMaxOrderExports = (SELECT MAX(`order`)+1 FROM `sys_objects_exports`);
INSERT INTO `sys_objects_exports` (`object`, `title`, `class_name`, `class_file`, `order`, `active`) VALUES
('ch_feedback', '_feedback', 'ChFdbExport', 'modules/cheetah/feedback/classes/ChFdbExport.php', @iMaxOrderExports, 1);
