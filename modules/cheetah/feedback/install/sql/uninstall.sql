...
DELETE FROM `sys_menu_admin` WHERE `name`='ch_feedback';
...
DELETE FROM `sys_objects_cmts` WHERE `ObjectName`='ch_feedback' LIMIT 1;
DELETE FROM `sys_objects_vote` WHERE `ObjectName`='ch_feedback' LIMIT 1;
DELETE FROM `sys_objects_tag` WHERE `ObjectName`='ch_feedback' LIMIT 1;
DELETE FROM `sys_objects_search` WHERE `ObjectName`='ch_feedback' LIMIT 1;
...
DELETE FROM `sys_objects_actions` WHERE `Type`='ch_feedback';

DELETE FROM `sys_sbs_entries` USING `sys_sbs_types`, `sys_sbs_entries` WHERE `sys_sbs_types`.`id`=`sys_sbs_entries`.`subscription_id` AND `sys_sbs_types`.`unit`='ch_feedback';
DELETE FROM `sys_sbs_types` WHERE `unit`='ch_feedback';
...
-- sitemap
DELETE FROM `sys_objects_site_maps` WHERE `object`='ch_feedback';

-- chart
DELETE FROM `sys_objects_charts` WHERE `object` = 'ch_feedback';

-- export
DELETE FROM `sys_objects_exports` WHERE `object` = 'ch_feedback';
