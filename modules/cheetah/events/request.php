...
class ChEventsRequest extends ChWsbRequest
{
    ...
    public static function processAsAction($aModule, &$aRequest, $sClass = "Module")
    {
        ...
        $GLOBALS['oTopMenu']->setCustomSubActions($aVars, 'ch_events_title', false);

        return ChWsbRequest::processAsAction($aModule, $aRequest, $sClass);
    }
}

ChEventsRequest::processAsAction($GLOBALS['aModule'], $GLOBALS['aRequest']);
