...
class ChEventsFormAdd extends ChWsbFormMedia
{
    var $_oMain, $_oDb;
    ...
    function __construct ($oMain, $iProfileId, $iEntryId = 0, $iThumb = 0)
    {
        ...
        if (ChWsbRequest::serviceExists('photos', 'perform_photo_upload', 'Uploader'))
            $this->_aMedia['images'] = array (
                ...
                'tag' => CH_EVENTS_PHOTOS_TAG,
                'cat' => CH_EVENTS_PHOTOS_CAT,
                'thumb' => 'PrimPhoto',
                'module' => 'photos',
                'title_upload_post' => 'images_titles',
                'title_upload' => _t('_ch_events_form_caption_file_title'),
        ...
        if (ChWsbRequest::serviceExists('videos', 'perform_video_upload', 'Uploader'))
            $this->_aMedia['videos'] = array (
                ...
                'tag' => CH_EVENTS_VIDEOS_TAG,
                'cat' => CH_EVENTS_VIDEOS_CAT,
                'thumb' => false,
                'module' => 'videos',
        ...
        if (ChWsbRequest::serviceExists('sounds', 'perform_music_upload', 'Uploader'))
            $this->_aMedia['sounds'] = array (
                ...
                'tag' => CH_EVENTS_SOUNDS_TAG,
                'cat' => CH_EVENTS_SOUNDS_CAT,
                'thumb' => false,
                'module' => 'sounds',
        ...
        if (ChWsbRequest::serviceExists('files', 'perform_file_upload', 'Uploader'))
            $this->_aMedia['files'] = array (
                ...
                'tag' => CH_EVENTS_FILES_TAG,
                'cat' => CH_EVENTS_FILES_CAT,
                'thumb' => false,
                'module' => 'files',
        ...
        $aInputPrivacyCustom[] = array ('key' => 'p', 'value' => _t('_ch_events_privacy_participants_only'));
        ...
        $aInputPrivacyCustom2 = array (
            array('key' => 'p', 'value' => _t('_ch_events_privacy_participants')),
            array('key' => 'a', 'value' => _t('_ch_events_privacy_admins_only'))
        );
        ...
        $aInputPrivacyViewParticipants = $GLOBALS['oChEventsModule']->_oPrivacy->getGroupChooser($iProfileId, 'events', 'view_participants');
        $aInputPrivacyViewParticipants['values'] = array_merge($aInputPrivacyViewParticipants['values'], $aInputPrivacyCustom);

        $aInputPrivacyComment = $GLOBALS['oChEventsModule']->_oPrivacy->getGroupChooser($iProfileId, 'events', 'comment');
        ...
        $aInputPrivacyRate = $GLOBALS['oChEventsModule']->_oPrivacy->getGroupChooser($iProfileId, 'events', 'rate');
        ...
        $aInputPrivacyForum = $GLOBALS['oChEventsModule']->_oPrivacy->getGroupChooser($iProfileId, 'events', 'post_in_forum');
        ...
        $aInputPrivacyForumView = $GLOBALS['oChEventsModule']->_oPrivacy->getGroupChooser($iProfileId, 'events', 'view_forum');
        ...
        $aCustomForm = array(
            ...
            'inputs' => array(
                ...
                'header_info' => array(
                    'type' => 'block_header',
                    'caption' => _t('_ch_events_form_header_info')
                ),

                'Title' => array(
                    'type' => 'text',
                    'name' => 'Title',
                    'caption' => _t('_ch_events_caption_title'),
                    'required' => true,
                    'checker' => array (
                        'func' => 'length',
                        'params' => array(3,100),
                        'error' => _t ('_ch_events_err_title'),
                    ),
                    'db' => array (
                        'pass' => 'Xss',
                    ),
                ...
                'Description' => array(
                    'type' => 'textarea',
                    'name' => 'Description',
                    'caption' => _t('_ch_events_caption_desc'),
                    'required' => true,
                    'html' => 2,
                    'checker' => array (
                        'func' => 'length',
                        'params' => array(20,64000),
                        'error' => _t ('_ch_events_err_desc'),
                    ),
                    'db' => array (
                        'pass' => 'XssHtml',
                    ),
                ...
                'City' => array(
                    'type' => 'text',
                    'name' => 'City',
                    'caption' => _t('_ch_events_caption_city'),
                    'required' => true,
                    'checker' => array (
                        'func' => 'length',
                        'params' => array(3,50),
                        'error' => _t ('_ch_events_err_city'),
                    ),
                    'db' => array (
                        'pass' => 'Xss',
                    ),
                ...
                'Place' => array(
                    'type' => 'text',
                    'name' => 'Place',
                    'caption' => _t('_ch_events_caption_place'),
                    'required' => true,
                    'checker' => array (
                        'func' => 'avail',
                        'error' => _t ('_ch_events_err_place'),
                    ),
                    'db' => array (
                        'pass' => 'Xss',
                    ),
                ...
                'EventStart' => array(
                    'type' => 'datetime',
                    'name' => 'EventStart',
                    'caption' => _t('_ch_events_caption_event_start'),
                    'required' => true,
                    'checker' => array (
                        'func' => 'DateTime',
                        'error' => _t ('_ch_events_err_event_start'),
                    ),
                    'db' => array (
                        'pass' => 'DateTimeUTC',
                    ),
                ...
                'EventEnd' => array(
                    'type' => 'datetime',
                    'name' => 'EventEnd',
                    'caption' => _t('_ch_events_caption_event_end'),
                    'required' => true,
                    'checker' => array (
                        'func' => 'DateTime',
                        'error' => _t ('_ch_events_err_event_end'),
                    ),
                    'db' => array (
                        'pass' => 'DateTimeUTC',
                    ),
                ...
                'Categories' => $oCategories->getGroupChooser ('ch_events', (int)$iProfileId, true),

                // images

                'header_images' => array(
                    'type' => 'block_header',
                    'caption' => _t('_ch_events_form_header_images'),
                    'collapsable' => true,
                    'collapsed' => false,
                ),
                'PrimPhoto' => array(
                    ...
                    'name' => 'PrimPhoto',
                    'caption' => _t('_ch_events_form_caption_thumb_choice'),
                    'info' => _t('_ch_events_form_info_thumb_choice'),
                    'required' => false,
                    'db' => array (
                        'pass' => 'Int',
                    ),
                ...
                'images_choice' => array(
                    ...
                    'name' => 'images_choice[]',
                    'caption' => _t('_ch_events_form_caption_images_choice'),
                    'info' => _t('_ch_events_form_info_images_choice'),
                    'required' => false,
                ),
                'images_upload' => array(
                    'type' => 'custom',
                    ...
                    'name' => 'images_upload[]',
                    'caption' => _t('_ch_events_form_caption_images_upload'),
                    'info' => _t('_ch_events_form_info_images_upload'),
                    'required' => false,
                ),
                ...
                'header_videos' => array(
                    'type' => 'block_header',
                    'caption' => _t('_ch_events_form_header_videos'),
                    'collapsable' => true,
                    'collapsed' => false,
                ),
                'videos_choice' => array(
                    ...
                    'name' => 'videos_choice[]',
                    'caption' => _t('_ch_events_form_caption_videos_choice'),
                    'info' => _t('_ch_events_form_info_videos_choice'),
                    'required' => false,
                ),
                'videos_upload' => array(
                    'type' => 'custom',
                    ...
                    'name' => 'videos_upload[]',
                    'caption' => _t('_ch_events_form_caption_videos_upload'),
                    'info' => _t('_ch_events_form_info_videos_upload'),
                    'required' => false,
                ),
                ...
                'header_sounds' => array(
                    'type' => 'block_header',
                    'caption' => _t('_ch_events_form_header_sounds'),
                    'collapsable' => true,
                    'collapsed' => false,
                ),
                'sounds_choice' => array(
                    ...
                    'name' => 'sounds_choice[]',
                    'caption' => _t('_ch_events_form_caption_sounds_choice'),
                    'info' => _t('_ch_events_form_info_sounds_choice'),
                    'required' => false,
                ),
                'sounds_upload' => array(
                    'type' => 'custom',
                    ...
                    'name' => 'sounds_upload[]',
                    'caption' => _t('_ch_events_form_caption_sounds_upload'),
                    'info' => _t('_ch_events_form_info_sounds_upload'),
                    'required' => false,
                ),
                ...
                'header_files' => array(
                    'type' => 'block_header',
                    'caption' => _t('_ch_events_form_header_files'),
                    'collapsable' => true,
                    'collapsed' => false,
                ),
                'files_choice' => array(
                    ...
                    'name' => 'files_choice[]',
                    'caption' => _t('_ch_events_form_caption_files_choice'),
                    'info' => _t('_ch_events_form_info_files_choice'),
                    'required' => false,
                ),
                'files_upload' => array(
                    'type' => 'custom',
                    ...
                    'name' => 'files_upload[]',
                    'caption' => _t('_ch_events_form_caption_files_upload'),
                    'info' => _t('_ch_events_form_info_files_upload'),
                    'required' => false,
                ),
                ...
                'header_privacy' => array(
                    'type' => 'block_header',
                    'caption' => _t('_ch_events_form_header_privacy'),
                ),

                'allow_view_event_to' => $GLOBALS['oChEventsModule']->_oPrivacy->getGroupChooser($iProfileId, 'events', 'view_event'),
                ...
                'allow_join_to' => $GLOBALS['oChEventsModule']->_oPrivacy->getGroupChooser($iProfileId, 'events', 'join'),

                'JoinConfirmation' => array (
                    'type' => 'select',
                    'name' => 'JoinConfirmation',
                    'caption' => _t('_ch_events_form_caption_join_confirmation'),
                    'info' => _t('_ch_events_form_info_join_confirmation'),
                    'values' => array(
                        0 => _t('_ch_events_form_join_confirmation_disabled'),
                        1 => _t('_ch_events_form_join_confirmation_enabled'),
                    ),
                    'checker' => array (
                        'func' => 'int',
                        'error' => _t ('_ch_events_form_err_join_confirmation'),
                    ),
                    'db' => array (
                        'pass' => 'Int',
                    ),
        ...
        if ($GLOBALS['oChEventsModule']->isAdmin()) {
            ...
            $aMemberships = array('' => _t('_ch_events_membership_filter_none')) + $aMemberships;
            $aFormInputsAdminPart = array (
                'EventMembershipFilter' => array(
                    'type' => 'select',
                    'name' => 'EventMembershipFilter',
                    'caption' => _t('_ch_events_caption_membership_filter'),
                    'info' => _t('_ch_events_info_membership_filter'),
                    'values' => $aMemberships,
                    'value' => '',
                    'checker' => array (
                        'func' => 'preg',
                        'params' => array('/^[0-9a-zA-Z]*$/'),
                        'error' => _t ('_ch_events_err_membership_filter'),
                    ),
                    'db' => array (
                        'pass' => 'Preg',
                        'params' => array('/([0-9a-zA-Z]*)/'),
