...
-- pages and blocks
DELETE FROM `sys_page_compose_pages` WHERE `Name` IN ('ch_mbp_my_membership', 'ch_mbp_join');
DELETE FROM `sys_page_compose` WHERE `Page` IN ('ch_mbp_my_membership', 'ch_mbp_join');
