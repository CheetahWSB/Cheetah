...
('ch_mbp_my_membership', 'Membership My', @iPCPOrder + 1),
('ch_mbp_join', 'Membership Join', @iPCPOrder + 2);

INSERT INTO `sys_page_compose` (`Page`, `PageWidth`, `Desc`, `Caption`, `Column`, `Order`, `Func`, `Content`, `DesignBox`, `ColWidth`, `Visible`, `MinWidth`) VALUES
('ch_mbp_join', '1140px', 'Select Level', '_membership_bcaption_purchase_level', 1, 1, 'Select', '', 1, 100, 'non', 0),

('ch_mbp_my_membership', '1140px', 'My Level', '_membership_bcaption_my_status', 1, 0, 'Current', '', 1, 28.1, 'memb', 0),
('ch_mbp_my_membership', '1140px', 'Available Levels', '_membership_bcaption_select_level', 2, 0, 'Available', '', 1, 71.9, 'memb', 0);


-- cron
INSERT INTO `sys_cron_jobs` (`name`, `time`, `class`, `file`, `eval`) VALUES
(@sModuleName, '* * * * *', 'ChMbpCron', 'modules/cheetah/membership/classes/ChMbpCron.php', '');


-- alerts
INSERT INTO `sys_alerts_handlers`(`name`, `class`, `file`, `eval`) VALUES
(@sModuleName, 'ChMbpResponse', 'modules/cheetah/membership/classes/ChMbpResponse.php', '');
