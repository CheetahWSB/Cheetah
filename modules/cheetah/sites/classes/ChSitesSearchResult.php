...
class ChSitesSearchResult extends ChTemplSearchResult
{
    var $isError;
    var $_oMain;
    var $sUnitTemplate;
    ...
    function __construct($sMode = '', $sValue = '', $sValue2 = '', $sValue3 = '')
    {
        ...
        $oVotingView = new ChTemplVotingView('ch_sites', 0);
        $this->oVotingView = $oVotingView->isEnabled() ? $oVotingView : null;

        $this->aCurrent['title'] = _t('_ch_sites');
        $this->aCurrent['paginate']['perPage'] = getParam('ch_sites_per_page');
        ...
        switch ($sMode) {
            ...
            case 'user':
                if ($sValue) {
                    ...
                    if ($iProfileId) {
                        $this->aCurrent['title'] = _t('_ch_sites_caption_browse_by_user') . $sValue;
            ...
            case 'category':
                ...
                $this->aCurrent['title'] = _t('_ch_sites_caption_browse_by_category') . ' ' . $sCategory;
                $GLOBALS['oTopMenu']->setCustomSubHeader(_t('_ch_sites_caption_browse_by_category') . ' ' . $sCategory);
            ...
            case 'tag':
                ...
                $this->aCurrent['title'] = _t('_ch_sites_caption_browse_by_tag') . ' ' . $sTag;
                $GLOBALS['oTopMenu']->setCustomSubHeader(_t('_ch_sites_caption_browse_by_tag') . ' ' . $sTag);
                $this->sSitesBrowseUrl = 'browse/all';
                break;

            case 'all':
                $this->aCurrent['title'] = _t('_ch_sites_caption_browse_all');
                $this->sSitesBrowseUrl = 'browse/all';
                break;

            case 'recent':
                $this->aCurrent['paginate']['perPage'] = 1;
                $this->aCurrent['restriction']['public']['value'] = CH_WSB_PG_ALL;
            ...
            case 'featured':
                ...
                $this->aCurrent['title'] = _t('_ch_sites_caption_browse_featured');
            ...
            case 'top':
                ...
                $this->aCurrent['title'] = _t('_ch_sites_caption_browse_top_rated');
                $this->sSitesBrowseUrl = 'browse/top';
                break;

            case 'popular':
                $this->aCurrent['sorting'] = 'popular';
                $this->aCurrent['title'] = _t('_ch_sites_caption_browse_popular');
            ...
            case 'search':
                ...
                $this->aCurrent['title'] = _t('_ch_sites_caption_search_results') . ' ' . $sValue;
            ...
            case 'admin':
                ...
                $this->aCurrent['title'] = _t('_ch_sites_caption_browse_admin');
            ...
            case 'users':
                ...
                $this->aCurrent['title'] = _t('_ch_sites_caption_browse_profile');
            ...
            case 'calendar':
                ...
                $this->aCurrent['title'] = _t('_ch_sites_caption_browse_by_day')
                    . getLocaleDate( strtotime("{$sValue}-{$sValue2}-{$sValue3}"), CH_WSB_LOCALE_DATE_SHORT);
        ...
        if (!$this->isError) {
            if (isset($this->aCurrent['rss']))
                $this->aCurrent['rss']['link'] = CH_WSB_URL_ROOT . $this->_oMain->_oConfig->getBaseUri() . $this->sSitesBrowseUrl;

            if (ch_get('rss') !== false && ch_get('rss')) {
                $this->aCurrent['ownFields'][] = 'description';
                $this->aCurrent['ownFields'][] = 'date';
                $this->aCurrent['paginate']['perPage'] = $this->_oMain->_oDb->getParam('ch_sites_max_rss_num');
            }
        }
    ...
    function showPagination($aParams = array())
    {
        ...
        $sUrlStart = CH_WSB_URL_ROOT . $oConfig->getBaseUri() . $this->sSitesBrowseUrl;
    ...
    function showPaginationAjax()
    {
        ...
        $oPaginate = new ChWsbPaginate(array(
            ...
            'per_page' => $this->aCurrent['paginate']['perPage'],
            'page' => $this->aCurrent['paginate']['page'],
            'view_all_url' => CH_WSB_URL_ROOT . $oConfig->getBaseUri() . $this->sSitesBrowseAll,
            'info' => false,
            'view_all' => true,
            'page_links' => false,
    ...
    {
        return ChWsbModule::getInstance('ChSitesModule');
    }
