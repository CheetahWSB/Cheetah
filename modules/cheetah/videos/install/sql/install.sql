...
('category_auto_app_[db_prefix]', 'on', @iKatID, 'Autoapprove categories of videos', 'checkbox', '', '', 10, ''),
('[db_prefix]_cat_required', 'on', @iKatID, 'Require category when editing', 'checkbox', '', '', 20, ''),
('[db_prefix]_allowed_exts', 'avi flv mpg wmv mp4 m4v mov divx xvid mpeg 3gp webm', @iKatID, 'Allowed extensions', 'digit', '', '', 30, ''),
('[db_prefix]_max_file_size', '64', @iKatID, 'Maximum size of one file (in Megabytes)', 'digit', '', '', 40, ''),
('[db_prefix]_profile_album_name', '{nickname}\'s videos', @iKatID, 'Default profile album name', 'digit', '', '', 50, ''),
('[db_prefix]_mode_index', 'last', @iKatID, 'Default sort on main index page<br /> (if enabled in the template)', 'select', '', '', 60, 'last,top'),
('[db_prefix]_number_index', '9', @iKatID, 'How many videos show on main index page', 'digit', '', '', 70, ''),
('[db_prefix]_number_home', '12', @iKatID, 'How many videos show on videos home page', 'digit', '', '', 80, ''),
('[db_prefix]_number_all', '12', @iKatID, 'How many videos show on browse videos page', 'digit', '', '', 90, ''),
('[db_prefix]_number_top', '3', @iKatID, 'How many videos show in featured, top, and similar sections', 'digit', '', '', 100, ''),
('[db_prefix]_number_related', '3', @iKatID, 'Number of related videos by user', 'digit', '', '', 110, ''),
('[db_prefix]_number_previous_rated', '3', @iKatID, 'Number of previous rated videos', 'digit', '', '', 120, ''),
('[db_prefix]_number_albums_home', '3', @iKatID, 'How many albums show on videos home page', 'digit', '', '', 130, ''),
('[db_prefix]_number_albums_browse', '9', @iKatID, 'How many albums show on browse albums page', 'digit', '', '', 140, ''),
('[db_prefix]_number_view_album', '3', @iKatID, 'How many videos show on view album page', 'digit', '', '', 150, ''),
('[db_prefix]_file_width', '600', @iKatID, 'Width of video player (in pixels)', 'digit', '', '', 160, ''),
('[db_prefix]_file_height', '600', @iKatID, 'Height of video player (in pixels)', 'digit', '', '', 170, ''),
('[db_prefix]_uploader_switcher', 'html5', @iKatID, 'Available uploaders', 'list', '', '', 180, 'html5,embed');
...
INSERT INTO `sys_page_compose` (`Page`, `PageWidth`, `Desc`, `Caption`, `Column`, `Order`, `Func`, `Content`, `DesignBox`, `ColWidth`, `Visible`, `MinWidth`) VALUES
('index', '1140px', 'Public Videos', '_[db_prefix]_public', 0, 0, 'PHP', 'require_once(CH_DIRECTORY_PATH_MODULES . ''cheetah/videos/classes/ChVideosSearch.php'');\r\n $oMedia = new ChVideosSearch();\r\n $aVisible[] = CH_WSB_PG_ALL;\r\n if ($this->iMemberID > 0)\r\n $aVisible[] = CH_WSB_PG_MEMBERS;\r\n $aCode = $oMedia->getBrowseBlock(array(''allow_view''=>$aVisible), array(''menu_top''=>true, ''sorting'' => getParam(''[db_prefix]_mode_index''), ''per_page''=>(int)getParam(''[db_prefix]_number_index'')));\r\n return array($aCode[''code''], $aCode[''menu_top''], $aCode[''menu_bottom''], $aCode[''wrapper'']);', 1, 71.9, 'non,memb', 0),
('member', '1140px', 'Video Albums', '_[db_prefix]_albums', 0, 0, 'PHP', 'return ChWsbService::call(''videos'', ''get_profile_albums_block'', array($this->iMember, CH_WSB_URL_ROOT . ''member.php''), ''Search'');', 1, 71.9, 'non,memb', 0),
('profile', '1140px', 'Video Albums', '_[db_prefix]_albums', 0, 0, 'PHP', 'return ChWsbService::call(''videos'', ''get_profile_albums_block'', array($this->oProfileGen->_iProfileID), ''Search'');', 1, 28.1, 'non,memb', 0),
('profile', '1140px', 'Profile Videos', '_[db_prefix]_profile_videos', 0, 0, 'PHP', 'return ChWsbService::call(''videos'', ''profile_video_block'', array($this->oProfileGen->_iProfileID), ''Search'');', 1, 71.9, 'non,memb', 0);
...
INSERT INTO `sys_menu_member` SET `Name` = 'ch_videos', `Eval` = 'return ChWsbService::call(''videos'', ''get_member_menu_item_add_content'');', `Position`='top_extra', `Type` = 'linked_item', `Parent` = IFNULL(@iMemberMenuParent, 0), `Order` = IFNULL(@iMemberMenuOrder, 1);
...
('[db_prefix]', '[db_prefix]_cmts', 'sys_cmts_track', 0, 1, 90, 20, 1, -3, 'none', 0, 1, 0, 'cmt', 'RayVideoFiles', 'ID', 'CommentsCount', 'ChVideosCmts', 'modules/cheetah/videos/classes/ChVideosCmts.php'),
('[db_prefix]_albums', '[db_prefix]_cmts_albums', 'sys_cmts_track', 0, 1, 90, 20, 1, -3, 'none', 0, 1, 0, 'cmt', '', '', '', 'ChVideosCmtsAlbums', 'modules/cheetah/videos/classes/ChVideosCmtsAlbums.php');
...
VALUES ('[db_prefix]', '[db_prefix]_rating', '[db_prefix]_voting_track', 'gal_', 5, 'vote_send_result', 'CH_PERIOD_PER_VOTE', 1, 'ChVideosRate', 'modules/cheetah/videos/classes/ChVideosRate.php', 'RayVideoFiles', 'Rate', 'RateCount', 'ID');
...
(@iTMParentId, 'VideosSearch', '_[db_prefix]_top_menu_search', 'searchKeyword.php?type=ch_videos', 40, 'non,memb', '', '', '', 1, 1, 1, 'custom', '', 0, '');
...
VALUES ('[db_prefix]', '_[db_prefix]', 'ChVideosSearch', 'modules/cheetah/videos/classes/ChVideosSearch.php');

INSERT INTO `sys_categories` (`Category`, `ID`, `Type`, `Owner`, `Status`) VALUES
('Profile videos', 0, 'ch_videos', 0, 'active'),
('Our lovely kids', 0, 'ch_videos', 0, 'active'),
('It is me!', 0, 'ch_videos', 0, 'active'),
('Fun', 0, 'ch_videos', 0, 'active'),
('Music clips', 0, 'ch_videos', 0, 'active'),
('About vacations', 0, 'ch_videos', 0, 'active');
...
('[db_prefix]', '{evalResult}', 'edit', '', 'oChWsbFiles.edit({ID})', '$sTitle = _t(''_Edit'');\r\nif ({Owner} == {iViewer})\r\nreturn $sTitle;\r\n$mixedCheck = ChWsbService::call(''videos'', ''check_action'', array(''edit'',''{ID}''));\r\nif ($mixedCheck !== false)\r\nreturn $sTitle;\r\nelse\r\n return null;', 5),
('[db_prefix]', '{evalResult}', 'remove', '', 'getHtmlData(''ajaxy_popup_result_div_{ID}'', ''{moduleUrl}delete/{ID}/{AlbumUri}/{OwnerName}'', false, ''post'', true); return false;', '$sTitle = _t(''_Delete'');\r\nif ({Owner} == {iViewer})\r\nreturn $sTitle;\r\n$mixedCheck = ChWsbService::call(''videos'', ''check_delete'', array({ID}));\r\nif ($mixedCheck !== false)\r\nreturn $sTitle;\r\nelse\r\nreturn null;', 6),
...
('[db_prefix]_title', '{evalResult}', 'plus', '', 'showPopupAnyHtml(''{BaseUri}upload'');', 'return (getLoggedId() && ChWsbModule::getInstance(''ChVideosModule'')->isAllowedAdd()) ? _t(''_sys_upload'') : '''';', 1),
...
('[db_prefix]_album', '{evalResult}', 'remove', '', 'getHtmlData(''ajaxy_popup_result_div_{ID}'', ''{moduleUrl}album_delete/{albumUri}'', false, ''post'', true); return false;', 'return (getLoggedId() && ChWsbModule::getInstance(''ChVideosModule'')->isAllowedDeleteAlbum({ID})) ? _t(''_Delete'') : '''';', 1);


INSERT INTO `sys_email_templates` (`Name`, `Subject`, `Body`, `Desc`, `LangID`) VALUES
('t_ch_videos_share', 'Check This Out!', '<ch_include_auto:_email_header.html />\r\n\r\n<p><b>Hello</b>,</p>\r\n\r\n<p><SenderNickName> shared a <a href="<MediaUrl>"><MediaType></a> with you!</p>\r\n\r\n<hr>\r\n\r\n<UserExplanation>\r\n\r\n<hr>\r\n\r\n<ch_include_auto:_email_footer.html />', 'Video sharing', 0),
('t_ch_videos_report', '<SenderNickName> Reported A Video', '<ch_include_auto:_email_header.html />\r\n\r\n<p><a href="<MediaUrl>">Reported <MediaType></a></p>\r\n\r\n<hr>\r\n\r\n<UserExplanation>\r\n\r\n<hr>\r\n\r\n<ch_include_auto:_email_footer.html />', 'Video report', 0),
('t_sbs_ch_videos_comments', 'New Comments To A Video', '<ch_include_auto:_email_header.html />\r\n\r\n<p><b>Dear <RealName></b>,</p>\r\n\r\n<br /><p>The <a href="<ViewLink>">video you subscribed to got new comments!</a></p>\r\n\r\n<ch_include_auto:_email_footer.html />', 'Subscription: new comments to video', 0);
...
(NULL, '_ch_videos', '__pvi__ (<a href="modules/?r=videos/albums/my/main/">__l_add__</a>)');
...
(2, '[db_prefix]', '_[db_prefix]', '{siteUrl}modules/?r=videos/administration', 'Videos module by Cheetah', 'film', @iMax+1);

INSERT INTO `sys_cron_jobs` (`name`, `time`, `class`, `file`, `eval`) VALUES
('[db_prefix]', '*/5', 'ChWsbCronVideo', 'flash/modules/video/inc/classes/ChWsbCronVideo.php', '');
...
('[db_prefix]', '', '', 'return ChWsbService::call(''videos'', ''get_subscription_params'', array($arg2, $arg3));'),
('[db_prefix]', 'commentPost', 't_sbs_[db_prefix]_comments', 'return ChWsbService::call(''videos'', ''get_subscription_params'', array($arg2, $arg3));');


INSERT INTO `sys_alerts_handlers` (`name`, `eval`) VALUES ('[db_prefix]_profile_delete', 'ChWsbService::call(''videos'', ''response_profile_delete'', array($this));');
...
('[db_prefix]', 'homepage', '_ch_videos', 'home_videos.png', 8, '', '', '',  @iMaxOrderHomepage, 1),
('[db_prefix]', 'profile', '_ch_videos', '', 8, '', 'return ChWsbXMLRPCMedia::_getMediaCount(''video'', ''{profile_id}'', ''{member_id}'');', '', @iMaxOrderProfile, 1);
...
('[db_prefix]', '_ch_videos', '0.8', 'auto', 'ChVideosSiteMapsVideos', 'modules/cheetah/videos/classes/ChVideosSiteMapsVideos.php', @iMaxOrderSiteMaps, 1),
('[db_prefix]_albums', '_ch_videos_albums', '0.8', 'auto', 'ChVideosSiteMapsAlbums', 'modules/cheetah/videos/classes/ChVideosSiteMapsAlbums.php', @iMaxOrderSiteMaps + 1, 1);

-- chart

SET @iMaxOrderCharts = (SELECT MAX(`order`)+1 FROM `sys_objects_charts`);
INSERT INTO `sys_objects_charts` (`object`, `title`, `table`, `field_date_ts`, `field_date_dt`, `query`, `active`, `order`) VALUES
('[db_prefix]', '_ch_videos', 'RayVideoFiles', 'Date', '', '', 1, @iMaxOrderCharts);

-- export

SET @iMaxOrderExports = (SELECT MAX(`order`)+1 FROM `sys_objects_exports`);
INSERT INTO `sys_objects_exports` (`object`, `title`, `class_name`, `class_file`, `order`, `active`) VALUES
('[db_prefix]', '_ch_videos', 'ChVideosExport', 'modules/cheetah/videos/classes/ChVideosExport.php', @iMaxOrderExports, 1);
