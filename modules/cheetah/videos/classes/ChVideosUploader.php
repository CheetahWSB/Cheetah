...
class ChVideosUploader extends ChWsbFilesUploader
{
    // constructor
    ...
    function GenSendFileInfoForm($iFileID, $aDefaultValues = array())
    {
        ...
        if(isset($aDefaultValues['image']))
            ...
            $aVideoInfo = ChWsbService::call('videos', 'get_video_array', array($iFileID), 'Search');
    ...
    function serviceAcceptEmbedFile()
    {
        ...
        $aSiteInfo['duration'] = ch_parse_time_duration($aSiteInfo['duration']);
