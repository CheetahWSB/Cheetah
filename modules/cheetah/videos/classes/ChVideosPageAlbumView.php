...
require_once('ChVideosCmtsAlbums.php');

class ChVideosPageAlbumView extends ChWsbPageView
{
    var $aInfo;
    var $iProfileId;
    ...
    {
        parent::__construct('ch_videos_album_view');
        $this->aInfo = $aInfo;
    ...
    function getBlockCode_Comments()
    {
        ...
        $oCmtsView = new ChVideosCmtsAlbums($this->oConfig->getMainPrefix() . '_albums', $this->aInfo['ID']);
