...
class ChVideosSearch extends ChTemplSearchResultSharedMedia
{
    function __construct ($sParamName = '', $sParamValue = '', $sParamValue1 = '', $sParamValue2 = '')
    {
        parent::__construct('ChVideosModule');
        ...
        $this->aCurrent['rss']['title'] = _t('_ch_videos');

        $this->aAddPartsConfig['favorite']['table'] = 'ch_videos_favorites';
        $this->oModule = ChWsbModule::getInstance('ChVideosModule');
        ...
        switch ($sParamName) {
            case 'calendar':
                ...
                $this->aCurrent['title'] = _t('_ch_videos_caption_browse_by_day') . sprintf("%04u-%02u-%02u", $sParamValue, $sParamValue1, $sParamValue2);
                break;
            case 'top':
            ...
            case 'featured':
                $this->aCurrent['restriction']['featured'] = array(
                    'value'=>'1', 'field'=>'Featured', 'operator'=>'=', 'paramName'=>'ch_videos_mode'
                );
                break;
            case 'favorited':
    ...
    function serviceGetEntry($iId, $sType = 'browse')
    {
        ...
        $sqlQuery = "SELECT a.`ID` as `id`,
                        ...
                        WHERE a.`ID`='$iId' AND c.`Type`='ch_videos'";
