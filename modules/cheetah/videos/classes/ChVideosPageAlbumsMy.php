...
class ChVideosPageAlbumsMy extends ChWsbPageView
{
    var $oTemplate;
    var $oConfig;
    var $oDb;
    ...
    {
        parent::__construct('ch_videos_albums_my');
        ...
        $this->oSearch = new ChVideosSearch('album', $this->aAddParams[1], 'owner', getUsername($this->iOwnerId));

        $this->oAlbum = new ChWsbAlbums('ch_videos', $this->iOwnerId);
    ...
    function getBlockCode_addObjects ($iBoxId)
    {
        ...
        if (!$this->oSearch->oModule->isAllowedAdd()) {
            ...
            require_once('ChVideosUploader.php');
            ...
            $oUploader = new ChVideosUploader();
