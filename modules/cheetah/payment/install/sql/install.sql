...
('pmt_site_admin', '', @iCategoryId, 'Site administrator', 'select', '', '', 2, 'PHP:return ChWsbService::call(''payment'', ''get_admins'');'),
...
('ch_pmt_cart', 'Payment Shopping Cart', @iPCPOrder+1),
('ch_pmt_history', 'Payment Cart History', @iPCPOrder+2),
('ch_pmt_orders', 'Payment Order Administration', @iPCPOrder+3),
('ch_pmt_details', 'Payment Settings', @iPCPOrder+4);

INSERT INTO `sys_page_compose` (`Page`, `PageWidth`, `Desc`, `Caption`, `Column`, `Order`, `Func`, `Content`, `DesignBox`, `ColWidth`, `Visible`, `MinWidth`) VALUES
('ch_pmt_cart', '1140px', 'Site Cart', '_payment_bcpt_cart_featured', 1, 0, 'Featured', '', 1, 50, 'memb', 0),
('ch_pmt_cart', '1140px', 'Members Cart', '_payment_bcpt_cart_common', 2, 0, 'Common', '', 1, 50, 'memb', 0),
('ch_pmt_history', '1140px', 'History', '_payment_bcpt_cart_history', 1, 0, 'History', '', 1, 100, 'memb', 0),
('ch_pmt_orders', '1140px', 'Orders', '_payment_bcpt_processed_orders', 1, 0, 'Orders', '', 1, 100, 'memb', 0),
('ch_pmt_details', '1140px', 'Payment Details', '_payment_bcpt_details', 1, 0, 'Details', '', 1, 100, 'memb', 0);
...
(2, 'ch_payment', '_payment_amenu_payment', '{siteUrl}modules/?r=payment/admin/', 'For managing payment module', 'credit-card', '', '', @iOrder+1);

-- alert
INSERT INTO `sys_alerts_handlers`(`name`, `class`, `file`, `eval`) VALUES
('ch_payment', '', '', 'ChWsbService::call(\'payment\', \'response\', array($this));');
...
('ch_pmt_paid_need_join', 'Payment was accepted', '<ch_include_auto:_email_header.html />\r\n\r\n<p><b>Dear <RealName></b>,</p>\r\n\r\n<p>\r\nYour payment was accepted. If you did not fill in the join form yet, then you may do it using the following link. \r\n</p>\r\n\r\n<p>\r\n<a href="<JoinLink>">Join Now</a>\r\n</p>\r\n\r\n<ch_include_auto:_email_footer.html />', 'Payment: Paid and need to join', 0);

-- chart
SET @iMaxOrderCharts = (SELECT MAX(`order`)+1 FROM `sys_objects_charts`);
INSERT INTO `sys_objects_charts` (`object`, `title`, `table`, `field_date_ts`, `field_date_dt`, `query`, `active`, `order`) VALUES
('ch_pmt', '_payment_chart', 'ch_pmt_transactions', 'date', '', '', 1, @iMaxOrderCharts);

-- export
SET @iMaxOrderExports = (SELECT MAX(`order`)+1 FROM `sys_objects_exports`);
INSERT INTO `sys_objects_exports` (`object`, `title`, `class_name`, `class_file`, `order`, `active`) VALUES
('ch_pmt', '_payment', 'ChPmtExport', 'modules/cheetah/payment/classes/ChPmtExport.php', @iMaxOrderExports, 1);
...
('paypal', '_payment_pp_cpt', '_payment_pp_dsc', 'pp_', 1, 'ChPmtPayPal');
...
--
INSERT INTO `[db_prefix]providers`(`name`, `caption`, `description`, `option_prefix`, `for_visitor`, `class_name`) VALUES
('2checkout', '_payment_2co_cpt', '_payment_2co_dsc', '2co_', 1, 'ChPmt2Checkout');
SET @iProviderId = LAST_INSERT_ID();
...
--
INSERT INTO `[db_prefix]providers`(`name`, `caption`, `description`, `option_prefix`, `for_visitor`, `class_name`) VALUES
('bitpay', '_payment_bp_cpt', '_payment_bp_dsc', 'bp_', 0, 'ChPmtBitPay');
SET @iProviderId = LAST_INSERT_ID();
