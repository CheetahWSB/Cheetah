 ...
 */
                ...
                for( var i = 0; i < iResponseCount; i++ )
                {
                    ...
                    if (oResponse.senders[i].messages_list) {
                        ...
                        if ( oResponse.senders[i].messages_list != 'built-in') {
                            ...
                            // count all chat boxe's messages, if count of messages more than  25 for example (see this.iNumberVisibleMessages in ChSimpleMessengerModule.php);
    ...
    var oSimpleMessenger = new ChSimpleMessenger();
