    ...
    SET
        ...
        `Eval`    = 'return ChWsbService::call(''simple_messenger'', ''get_messenger_field'', array({ID}));',
        `Type` = 'Profile';
    ...
    SET
        ...
        `type`       = 'php',
        `data`       = 'return ChWsbService::call(''simple_messenger'', ''get_messenger_core'');', `replace`    = '0',
        `active`     = '1';

    --
    -- Table structure for table `ch_simple_messenger_messages`
    --
    ...
    --
    -- Table structure for table `ch_simple_messenger_privacy`
    --
	...
	('pedit', '1140px', 'Messenger Settings', '_simple_messenger_bcaption_settings', 2, IFNULL(@iMaxOrder, 0), 'PHP', 'return ChWsbService::call(''simple_messenger'', ''get_settings'');', 1, 28.1, 'memb', 0);
    ...
    INSERT INTO
        `sys_alerts_handlers`
    SET
        `name`  = 'ch_simple_messenger',
        `class` = 'ChSimpleMessengerResponse',
        `file`  = 'modules/cheetah/simple_messenger/classes/ChSimpleMessengerResponse.php';
    ...
    SET
        ...
        `check`     = 'ch_simple_messenger_permalinks';
    ...
    (`Name`, `VALUE`, `kateg`, `desc`, `Type`, `check`, `err_text`, `order_in_kateg`, `AvailableValues`)
        VALUES
    ('ch_simple_messenger_permalinks', 'on', 26, 'Enable friendly permalinks in simple messenger', 'checkbox', '', '', '0', '');
    ...
    ('ch_simple_messenger', '_simple_messenger_chart', 'ch_simple_messenger_messages', '', 'Date', '', 1, @iMaxOrderCharts);
    ...
    ('ch_simple_messenger', '_sys_module_simple_messenger', 'ChSimpleMessengerExport', 'modules/cheetah/simple_messenger/classes/ChSimpleMessengerExport.php', @iMaxOrderExports, 1);
