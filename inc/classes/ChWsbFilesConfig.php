...
require_once('ChWsbConfig.php');

class ChWsbFilesConfig extends ChWsbConfig
{
    var $sPrefix;
    ...
    function getUploaders ()
    {
        ...
        $oAlert = new ChWsbAlerts($this->getMainPrefix(), 'uploaders_init', 0, getLoggedId(), array('uploaders' => &$this->aUploaders, 'config' => $this));
        $oAlert->alert();
