...
class ChWsbCategories extends ChWsbTags
{
        ...
        if (isset($aParam['common'])) {
            ...
            if (is_array($aUnitsCommon)) {
                foreach ($aUnitsCommon as $sUnit)
                    $sCatsList .= process_db_input($sUnit, CH_TAGS_NO_ACTION, CH_SLASHES_NO_ACTION) . "','";
    ...
    function _insertTags ($aTagsSet)
    {
        ...
        foreach( $aTags as $sTag ) {
            $aTagsSet['tag'] = process_db_input($sTag, CH_TAGS_STRIP, CH_SLASHES_NO_ACTION);
