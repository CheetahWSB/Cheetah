...
class ChWsbExport
{
    ...
    protected function __construct($aSystem)
    {
        ...
        $this->_oQuery = new ChWsbExportQuery($this->_aSystem);
    }
    ...
    {
        if (isset($GLOBALS['chWsbClasses']['ChWsbExport!'.$sObject]))
            return $GLOBALS['chWsbClasses']['ChWsbExport!'.$sObject];
        ...
        return ($GLOBALS['chWsbClasses']['ChWsbExport!'.$sObject] = $o);
    }
    ...
    static public function & getSystems () {
        if (!isset($GLOBALS['ch_dol_export_systems']))
            $GLOBALS['ch_dol_export_systems'] = ChWsbExportQuery::getAllActiveSystemsFromCache ();
        return $GLOBALS['ch_dol_export_systems'];
    }
    ...
    static public function sendEmailNotification($aProfile, $sFilename)
    {
        ...
        $aTemplateVars = array (
            'FileUrl' => CH_WSB_URL_CACHE_PUBLIC . $sFilename,
        );
    ...
    protected function _getFilesFromStmt($sTableName, $oStmt, $aFields)
    {
        ...
        while ($r = $oStmt->fetch(PDO::FETCH_ASSOC)) {
            if(is_a($aFields, 'ChWsbExportFiles'))
