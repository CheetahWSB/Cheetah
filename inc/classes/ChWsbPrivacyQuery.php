...
class ChWsbPrivacyQuery extends ChWsbDb
{
    var $_sTable;
    var $_sFieldId;
    var $_sFieldOwnerId;
    ...
    function deleteGroupsById($mixedValues)
    {
        if(is_array($mixedValues)) {
            ...
            $sGroupIds = process_db_input($mixedValues, CH_TAGS_STRIP);
        }
    ...
    function getDefaultValueModule($sModuleUri, $sActionName)
    {
        ...
        return !empty($aAction) && isset($aAction['default_group']) ? $aAction['default_group'] : CH_WSB_PG_ALL;
    }
