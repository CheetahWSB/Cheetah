    ...
    <li><b>Web-server</b>:
        <ul>
            <li>
                ...
                <br />
                If it is not enabled then please consider implement this optimization, since it improve perceived site speed and save the bandwidth, refer to <a target="_blank" href="https://cheetah.deanbassett.com/trac/cheetah/wiki/HostingServerSetupRecommendations#Usersidecachingforstaticcontent">this tutorial</a> on how to do this.
                <br />
                <?php
            ...
            <li>
                ...
                <br />
                If it is not enabled then please consider implement this optimization, since it improve perceived site speed and save the bandwidth, refer to <a href="https://cheetah.deanbassett.com/trac/cheetah/wiki/HostingServerSetupRecommendations#Serversidecontentcompression">this tutorial</a> on how to do this.
                </textarea>
                <br />
                <?php
...
<p>
    Some things can not be determined automatically, manual server audit is required to check it. If you don't know how to do it by yourself you can submit <a target="_blank" href="https://cheetah.deanbassett.com/help/contact">Cheetah Server Audit Request</a>.
</p>
