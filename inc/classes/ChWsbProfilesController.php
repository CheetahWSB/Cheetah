...
class ChWsbProfilesController
{
    ...
    {
        $this -> oEmailTemplate = new ChWsbEmailTemplates();
    }
    ...
    function createProfile( $aData, $bSendMails = true, $iMainMemberID = 0 )
    {
        ...
        $this -> oPF = new ChWsbProfileFields(100);
    ...
    */
    function _checkUpdateMatchFields(&$aData)
    {
        ...
        $oMatchFields = new ChWsbProfileFields(101);
        $aMatchFields = $oMatchFields -> aArea[0]['Items'];

        // get array of all fields
        $oAllFields = new ChWsbProfileFields(100);
