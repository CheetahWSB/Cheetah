 ...
 */
     ...
     *
     * Related classes:
     *  @see ChBaseMemberMenu        - member menu base representation
     *  @see ChTemplMemberMenu       - member menu template representation
     *
     ...
     *       @see ChTemplMailBox::get_member_menu_bubble_new_messages;
     *
     ...
     *       it will form the content of your menu item ( @see ChWsbService::serviceGetMemberMenuLink )
    ...
    class ChWsbMemberMenu
    {
        ...
        function getCacheObject()
        {
            if ($this -> oCacheObject != null) {
                ...
                $this->oCacheObject = ch_instance ('ChWsbCache'.$sEngine);
                if (!$this->oCacheObject->isAvailable())
                    $this->oCacheObject = ch_instance ('ChWsbCacheFile');
                return $this->oCacheObject;
            }
        }
        ...
        function _parseStructure($aMemberInfo, $aMenuStructure)
        {
                        ...
                        if ( $aReplaced[$sPosition][$iKey]['Type'] == 'link'
                                ...
                                if($aReplaced[$sPosition][$iKey]['Name'] == 'MemberBlock') {
                                	...
                                	$sMenuImage = $GLOBALS['oSysTemplate']->parseHtmlByName('member_menu_thumbnail.html', array(
                                		...
                                		'ch_if:show_thumbnail_icon' => array(
                                			'condition' => !$bUserThumbnail,
                                			'content' => array()
                                		),
                                ...
                                $aContentKeys = array (
                                    ...
                                    'ch_if:reduce_element_top' => array (
                                    ...
                                    // draw reduce element by top side ;
                                    'ch_if:reduce_element_bottom' => array (
                                ...
                                $aDefinedMenuItems[$sPosition][$iIndex]['ch_if:sub_menu'] = array (
            ...
            if (ChWsbRequest::serviceExists('pageac', 'menu_items_filter')) {
                ChWsbService::call('pageac', 'menu_items_filter', array('member', &$aDefinedMenuItems));
            }
            ...
            //generate data
            $aTemplateKeys = array (
                'items' => $oSysTemplate->parseHtmlByName('extra_top_menu_items.html', array('ch_repeat:items' => $aDefinedMenuItems['top'])),
                'items_extra' => $oSysTemplate->parseHtmlByName('extra_top_menu_items.html', array('ch_repeat:items' => $aDefinedMenuItems['top_extra'])),
                'site_url' =>  CH_WSB_URL_ROOT,
                'menu_position' => $this -> sMemberMenuPosition,
                'is_profile_page' => defined('CH_PROFILE_PAGE') ? 'true' : 'false',
        ...
        */
        ...
        {
            if (isset($GLOBALS['ch_profiler'])) $GLOBALS['ch_profiler']->beginMenu('Member Menu');
            ...
            if (!$aMemberInfo) {
                if (isset($GLOBALS['ch_profiler'])) $GLOBALS['ch_profiler']->endMenu('Member Menu');
                return ;
            }
        ...
        */
        function createMemberMenuCache()
        {
            ...
            $oPermalink = new ChWsbPermalinks();
            $aCacheData = array();
