...
class ChWsbProfilesCalendar extends ChTemplCalendar
{
    var $sMode = 'dor';
...
EOF;
    ...
    function getBaseUri ()
    {
        ...
        return CH_WSB_URL_ROOT . "calendar.php?{$sPossibleMode}&date=";
    }

    function getBrowseUri ()
    {
        return CH_WSB_URL_ROOT .  "calendar.php?action=browse&date=";
    }
