...
define ('CH_OLD_VIEWS', 3*86400); // views older than this number of seconds will be deleted automatically
 ...
 * for example:
 *  new ChWsbViews('my_system', 25); // 25 - is object id
 *
...
class ChWsbViews
{
    ...
    function makeView ()
    {
        ...
        if ($iRet) {
            ...
            $oZ = new ChWsbAlerts($this->_sSystem, 'view', $this->getId(), $iMemberId);
            $oZ->alert();
