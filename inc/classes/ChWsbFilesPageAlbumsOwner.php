...
class ChWsbFilesPageAlbumsOwner extends ChWsbPageView
{
    var $oAlbum;
    var $oModule;
    var $oTemplate;
    ...
    function __construct($sPageName, &$oShared, $aParams = array())
    {
        ...
        $this->oAlbum   = new ChWsbAlbums($this->oConfig->getMainPrefix(), $this->iOwnerId);
    }
    ...
    function getBlockCode_Browse($iBlockId)
    {
        ...
        $aCustom['simple_paginate_url']      = $aCustom['paginate_url'] = CH_WSB_URL_ROOT . $this->oConfig->getBaseUri() . 'albums' . $sArg;
