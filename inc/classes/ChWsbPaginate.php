...
define('CH_WSB_PAGINATE_PER_PAGE_TYPE_FLOAT', 'float');
define('CH_WSB_PAGINATE_PER_PAGE_TYPE_STATIC', 'static');
define('CH_WSB_PAGINATE_PER_PAGE_STEP', 5);
define('CH_WSB_PAGINATE_PER_PAGE_INTERVAL', 3);
define('CH_WSB_PAGINATE_PER_PAGE_INTERVAL_MIN', 3);
define('CH_WSB_PAGINATE_PER_PAGE_VALUES', '10,20,50,100,200');
define('CH_WSB_PAGINATE_PER_PAGE_DEFAULT', 10);
define('CH_WSB_PAGINATE_RANGE', 3);
 ...
 *
 */
class ChWsbPaginate extends ChWsbTemplate
{
    var $_iStart;
    var $_iCount;
    var $_iPerPage;
    ...
    function __construct($aParams)
    {
        ...
        $this->_iPerPage = isset($aParams['per_page']) ? (int)$aParams['per_page'] : CH_WSB_PAGINATE_PER_PAGE_DEFAULT;
        $this->_sSorting = isset($aParams['sorting']) ? $aParams['sorting'] : '';
        $this->_sPageUrl = isset($aParams['page_url']) ? $aParams['page_url'] : CH_WSB_URL_ROOT;
        $this->_iRange = isset($aParams['range']) ? (int)$aParams['range'] : CH_WSB_PAGINATE_RANGE;
        $this->_iPage = isset($aParams['page']) ? (int)$aParams['page'] : 0;
        $this->_iPages = 0;
        $this->_sViewAllUrl = isset($aParams['view_all_url']) ? $aParams['view_all_url'] : CH_WSB_URL_ROOT;
    ...
    function _getPerPageChangerFloat()
    {
        ...
        $iInterval = $iInterval < CH_WSB_PAGINATE_PER_PAGE_INTERVAL_MIN ? CH_WSB_PAGINATE_PER_PAGE_INTERVAL_MIN : $iInterval;
