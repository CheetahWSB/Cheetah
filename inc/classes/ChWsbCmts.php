 ...
 *
 * Related classes:
 *  ChWsbCmtsQuery - comments database queries
 *  ChBaseCmtsView - comments base representation
 *  ChTemplCmtsView - custom template representation
 *
 ...
 * $o = new ChTemplCmtsView ('value of ObjectName field', $iYourEntryId);
 * if ($o->isEnabled())
 *     echo $o->getCommentsFirst ();
 *
 * Please note that you never need to use ChWsbCmts class directly, use ChTemplCmtsView instead.
 * Also if you override comments class with your own then make it child of ChTemplCmtsView class.
 *
 *
 *
 * Memberships/ACL:
