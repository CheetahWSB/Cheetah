...
class ChWsbFriendsPageView extends ChWsbPageView
{
    ...
    */
    function __construct($sPageName, &$aDisplayParameters, $iProfileID)
    {
        ...
        $this -> oProfile = new ChTemplProfileGenerator($iProfileID);
    }
    ...
    */
    function getBlockCode_Friends()
    {
        ...
        $sRequest = CH_WSB_URL_ROOT . 'viewFriends.php?';
        $sRequest .= ch_encode_url_params($_GET, array(), $aGetParams) . 'page={page}&per_page={per_page}&sort={sorting}';
    ...
    function getBlockCode_FriendsRequests()
    {
        ...
        $oCommunicator = new ChTemplCommunicator(array('member_id' => $this->iProfileID));
    ...
    */
    public static function get_member_menu_friends_list($iMemberId = 0)
    {
        ...
        $aTemplateKeys = array (
            ...
            'ch_repeat:friend_list' => $aFriends,
        );
