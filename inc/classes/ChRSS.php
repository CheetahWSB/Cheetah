...
class ChRSS
{
    ...
    function __construct( $url )
    {
        ...
        if( $url and $this -> sXmlText = ch_file_get_contents( $url ) )
    ...
    function _doFillFromText()
    {
        ...
        //get cheetah version
        if( $ind['cheetah']        and $vals[ $ind['cheetah'][0] ]['level'] == 3 )
            $this -> dolVersion      = $vals[ $ind['cheetah'][0] ]['value'];
        ...
        foreach( $ind['item'] as $itemInd ) {
            ...
            $this -> items[] = new ChRSSItem( $aItem );
        }
    }
}
