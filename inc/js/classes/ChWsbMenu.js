...
function ChWsbMenu( idContainer, urlParser, aTopItems, aCustomItems, aSystemItems, aInactiveItems, aCoords, e )
{
	if( !e )
		e = window.event;
	...
	{
		var oNewItem = new ChWsbMenuItem( this, aTopItems[id][0], 'top', aTopItems[id][1], this.iCounterX, 0, 0, aTopItems[id][2]);
		...
		{
			var oNewCItem = new ChWsbMenuItem( this, aCustomItems[id][cid][0], 'custom', aCustomItems[id][cid][1], this.iCounterX, (iCounterY + 1), 0, aCustomItems[id][cid][2]);
	...
	{
		var oNewSItem = new ChWsbMenuItem( this, aSystemItems[id][0], 'system', aSystemItems[id][1], this.iCounterX, 0, 0, aSystemItems[id][2]);
	...
	if( allowNewItem )
	{
		var oNewIItem = new ChWsbMenuItem( this, 0, 'inactive', sNewItemTitle, 1, this.iInactiveStartY, 0 );
	...
	{
		var oNewIItem = new ChWsbMenuItem( this, ( this.iMaxActiveID + 1 ), 'inactive', aInactiveItems[id], iInactiveCounterX, iInactiveCounterY, parseInt(id) );
	...
	this.movIndic = new ChWsbMenuMovIndic( this, 'mov_indic' );
...
ChWsbMenu.prototype.checkCollisions = function()
{
...
ChWsbMenu.prototype.redrawItems = function()
{
	//move top items
	var iTempCounterX = 0;
...
ChWsbMenu.prototype.resortItemsArrs = function()
{
	//resort arrays
	...
	for( ind = 0; ind < iItemsNum; ind ++ )
	{
		...
		else if( obj.cellY == 0 && obj.type == 'inactive' )
		{
			...
			var newObj = new ChWsbMenuItem( this, newObjID, 'top', obj.title, obj.cellX, 0 );
		...
		else if( obj.cellY > 0 && obj.cellY <= ( this.iMaxCounterY + 1 ) && obj.type == 'inactive' )
		{
			...
			var newObj = new ChWsbMenuItem( this, newObjID, 'custom', obj.title, obj.cellX, obj.cellY );
...
ChWsbMenu.prototype.saveItemsArrs = function()
{
	var sTopItems = '';
...
ChWsbMenu.prototype.resizePseudos = function()
{
...
ChWsbMenu.prototype.redrawInactiveItems = function()
{
	var iInactiveCounterX = 1;
	var iInactiveCounterY = this.iInactiveStartY;
...
ChWsbMenu.prototype.updateItem = function( id, title )
{
...
ChWsbMenu.prototype.deleteItem = function( id )
{
	if( this.editObj.id == id )
	{
...
function ChWsbMenuItem( parentObj, id, type, title, cellX, cellY, sourceID, movable)
{
...
ChWsbMenuItem.prototype.draw = function()
{
...
ChWsbMenuItem.prototype.dragStart = function( m )
{
...
ChWsbMenuItem.prototype.drag = function(m) {
...
ChWsbMenuItem.prototype.dragStop = function( m )
{
...
ChWsbMenuItem.prototype.moveToCell = function()
{
	var step = 10;
	var timeout = 10;
...
ChWsbMenuItem.prototype.setNewTitle = function( title )
{
	this.title = title;
...
function ChWsbMenuMovIndic( parent, elId )
{
	this.parent = parent;
...
ChWsbMenuMovIndic.prototype.show = function()
{
	this.element.style.display = 'block';
}

ChWsbMenuMovIndic.prototype.hide = function()
{
	this.element.style.display = 'none';
}

ChWsbMenuMovIndic.prototype.move = function() {
	var p = this.parent;
