...
require_once( CH_DIRECTORY_PATH_CLASSES . 'ChWsbProfilesController.php' );
...
class ChWsbSearchPageView extends ChWsbPageView
{
    var $oPF;
    ...
    function collectFilteredSettings()
    {
        $this->aFilterSortSettings = array (
            ...
            'sort' => (isset($_GET['sort'])) ? process_db_input($_GET['sort'], CH_TAGS_STRIP) : 'activity',
    ...
    function getBlockCode_SearchForm()
    {
        ...
        if(ch_get($sSrmKey) !== false)
            $aDefaultParams[$sSrmKey] = process_db_input(ch_get($sSrmKey));
        ...
        $sUrl = CH_WSB_URL_ROOT . 'search.php';
    ...
    function showMatchProfiles($iBlockID)
    {
        ...
        $oSearchProfile = new ChTemplSearchProfile();
...
$oSearchView = new ChWsbSearchPageView();
