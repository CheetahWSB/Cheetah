...
$iId = getLoggedId();
$oPrivacyView = new ChTemplPrivacyView($iId);
...
if(isset($_POST['ps_action']) && $_POST['ps_action'] == 'get_chooser' && $iId != 0) {
    ...
    if($iMemberId == $iProfileId) {
        ...
        $sCode = $GLOBALS['oSysTemplate']->parseHtmlByName('ps_page_menu.html', array('ch_repeat:items' => $aItems));
