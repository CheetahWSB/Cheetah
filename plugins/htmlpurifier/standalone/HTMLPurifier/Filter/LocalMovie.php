...
class HTMLPurifier_Filter_LocalMovie extends HTMLPurifier_Filter
{
    ...
    public function postFilter($html, $config, $context) {
        ...
        $post_replace = '<object style="display:block;" width="486" height="400" data="'.CH_WSB_URL_ROOT.'flash/modules/global/app/holder_as3.swf">'.
            '<param name="movie" value="'.CH_WSB_URL_ROOT.'flash/modules/global/app/holder_as3.swf"></param>'.
            '<param name="allowScriptAccess" value="always"></param>'.
            '<param name="allowFullScreen" value="true"></param>'.
            '<param name="base" value="'.CH_WSB_URL_ROOT.'flash/modules/\3/"></param>'.
            '<param name="bgcolor" value="#FFFFFF"></param>'.
            '<param name="wmode" value="opaque"></param>'.
            '<param name="flashVars" value="url='.$localhost.'\1\2\3\4"></param>'.
            '<embed src="'.CH_WSB_URL_ROOT.'flash/modules/global/app/holder_as3.swf"'.
            ' type="application/x-shockwave-flash"'.
            ' width="486" height="400"'.
            ' allowScriptAccess="always" allowFullScreen="true"'.
            ' base="'.CH_WSB_URL_ROOT.'flash/modules/\3/"'.
