 ...
 */
    ...
    require_once( CH_DIRECTORY_PATH_ROOT . "templates/tmpl_{$tmpl}/scripts/ChTemplBrowse.php" );

    // define some page variables
    $_page['name_index'] 	= 7;
    $_page['header'] 		= _t('_Browse Profiles', CH_WSB_URL_ROOT);
    ...
    $oBrowsePage = new ChTemplBrowse( $aFilteredSettings, $aDisplaySettings, 'browse_page' );
